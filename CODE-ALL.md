# ThurSky – Code aller Dateien

Diese Datei enthält den vollständigen Quellcode des Projektpakets.
...
collections:
  - name: "news"
    ...
    fields:
      ...
      - { label: "Veröffentlichungsdatum", name: "date", widget: "datetime", format: "YYYY-MM-DDTHH:mm:ssZ" }
...
:root {
  ...
  --danger: #a32626;
  --success: #277a45;
  --shadow: 0 16px 38px rgba(24, 64, 66, .12);
  --radius: 20px;
}
...
.site-header { position: sticky; top: 0; z-index: 100; display: flex; align-items: center; justify-content: space-between; gap: 18px; padding: 12px clamp(16px, 4vw, 54px); background: rgba(37,108,112,.97); box-shadow: 0 8px 25px rgba(0,0,0,.18); }
.brand { display: inline-flex; align-items: center; gap: 10px; color: white; text-decoration: none; font-weight: 800; font-size: 1.2rem; }
.brand img { width: 56px; height: 56px; object-fit: contain; }
.desktop-nav { display: flex; align-items: center; gap: 10px; }
.desktop-nav a, .nav-button { color: white; text-decoration: none; border: 0; background: transparent; padding: 10px 12px; border-radius: 10px; }
.desktop-nav a:hover, .nav-button:hover { background: rgba(255,255,255,.12); color: #fff; }
.menu-toggle { display: none; border: 0; background: transparent; color: #fff; font-size: 1.7rem; }
.hero { min-height: 64vh; display: grid; place-items: center; padding: 50px 20px; color: #fff; text-align: center; background: linear-gradient(rgba(15,37,38,.55), rgba(15,37,38,.62)), url('/assets/images/hero.jpg') center/cover no-repeat; }
.hero-inner { max-width: 850px; }
.hero h1 { font-size: clamp(2.3rem, 7vw, 5rem); line-height: 1; margin: 0 0 18px; }
.hero p { font-size: clamp(1rem, 2.4vw, 1.3rem); }
.hero-actions { display: flex; flex-wrap: wrap; justify-content: center; gap: 12px; margin-top: 25px; }
.page-shell { width: min(1180px, calc(100% - 32px)); margin: 0 auto; padding: 40px 0 70px; }
.section { margin: 36px 0; }
.section-heading { max-width: 760px; margin-bottom: 24px; }
.section-heading h2, .hero-small h1 { margin: 0 0 8px; font-size: clamp(1.8rem, 4vw, 3rem); }
.eyebrow { margin: 0 0 6px; text-transform: uppercase; letter-spacing: .12em; font-size: .78rem; font-weight: 800; color: var(--accent); }
.card { background: var(--surface); border: 1px solid var(--border); border-radius: var(--radius); box-shadow: var(--shadow); padding: clamp(20px, 4vw, 32px); }
.grid { display: grid; gap: 20px; }
.grid-2 { grid-template-columns: repeat(2, minmax(0, 1fr)); }
.grid-3 { grid-template-columns: repeat(3, minmax(0, 1fr)); }
.card h2, .card h3 { margin-top: 0; }
.btn { display: inline-flex; align-items: center; justify-content: center; min-height: 46px; padding: 11px 18px; border-radius: 12px; border: 1px solid transparent; text-decoration: none; font-weight: 750; }
...
input, select, textarea { width: 100%; border: 1px solid var(--border); border-radius: 11px; padding: 12px 13px; background: #fff; color: var(--text); }
input:focus, select:focus, textarea:focus { outline: 3px solid rgba(245,166,35,.2); border-color: var(--accent); }
.notice { border-radius: 12px; padding: 12px 14px; margin: 12px 0; background: #eef7f7; border-left: 4px solid var(--brand); }
.notice-error { background: #fff0f0; border-left-color: var(--danger); }
.notice-success { background: #effaf3; border-left-color: var(--success); }
.hidden { display: none !important; }
.status-pill { display: inline-flex; padding: 5px 10px; border-radius: 999px; background: #e8f1f1; font-size: .85rem; font-weight: 800; }
.dashboard-grid { display: grid; grid-template-columns: 240px minmax(0,1fr); gap: 24px; }
.sidebar { align-self: start; position: sticky; top: 95px; }
.sidebar nav { display: grid; gap: 8px; }
.sidebar button { text-align: left; border: 0; padding: 10px 12px; border-radius: 9px; background: transparent; color: var(--text); }
.sidebar button.active, .sidebar button:hover { background: #e6f0f0; color: var(--brand-dark); }
.table-wrap { overflow-x: auto; }
table { width: 100%; border-collapse: collapse; }
th, td { padding: 11px 10px; border-bottom: 1px solid var(--border); text-align: left; vertical-align: top; }
th { font-size: .84rem; text-transform: uppercase; letter-spacing: .04em; color: var(--muted); }
.news-grid { display: grid; gap: 22px; }
.news-card { display: grid; grid-template-columns: minmax(220px, 34%) 1fr; gap: 22px; }
.news-card img { width: 100%; height: 220px; object-fit: cover; border-radius: 14px; }
.article { max-width: 850px; margin: 0 auto; }
.article .lead { font-size: 1.15rem; color: var(--muted); }
.article-hero { width: 100%; max-height: 480px; object-fit: cover; border-radius: 15px; margin: 20px 0; }
.gallery { display: grid; grid-template-columns: repeat(auto-fit,minmax(180px,1fr)); gap: 15px; }
.gallery img, .gallery video { width: 100%; height: 190px; object-fit: cover; border-radius: 14px; }
.price-row { display: flex; justify-content: space-between; gap: 20px; padding: 13px 0; border-bottom: 1px solid var(--border); }
.site-footer { padding: 28px 20px; text-align: center; color: #fff; background: var(--brand); }
.spinner { width: 28px; height: 28px; border: 3px solid #d9e6e6; border-top-color: var(--brand); border-radius: 50%; animation: spin .8s linear infinite; }
@keyframes spin { to { transform: rotate(360deg); } }
@media (max-width: 820px) {
  .desktop-nav { display: none; position: absolute; top: 80px; right: 16px; left: 16px; padding: 12px; border-radius: 14px; background: var(--brand); flex-direction: column; align-items: stretch; }
  .desktop-nav.open { display: flex; }
  .menu-toggle { display: block; }
  .grid-2, .grid-3, .form-grid, .dashboard-grid, .news-card { grid-template-columns: 1fr; }
...
[
  {
    "slug": "willkommen",
    "title": "Willkommen bei ThurSky",
    "date": "2026-07-15T12:00:00.000Z",
    "description": "Neuigkeiten, Projekte und Einblicke rund um unsere Drohnenaufnahmen.",
    "image": "",
    "html": "<p>Hier veröffentlichen wir künftig Neuigkeiten zu Projekten, neuen Angeboten und besonderen Luftaufnahmen.</p>\n"
  }
]
```
...
```html
<!doctype html><html lang="de"><head><meta charset="utf-8"><meta name="viewport" content="width=device-width,initial-scale=1"><meta name="robots" content="noindex,nofollow"><title>Adminbackend | ThurSky</title><link rel="stylesheet" href="/assets/css/style.css"></head><body>
<header class="site-header"><a class="brand" href="/"><img src="/assets/images/logo.png" alt="ThurSky Logo"><span>Adminbackend</span></a><nav class="desktop-nav"><a href="/admin/">News bearbeiten</a><a href="/">Website</a><button class="nav-button" id="logoutButton">Abmelden</button></nav></header>
<main class="page-shell"><section class="hero-small"><p class="eyebrow">Verwaltung</p><h1>Bestellungen und Kunden</h1><p id="adminIdentity">Berechtigung wird geprüft …</p></section><div id="adminMessage"></div><div class="dashboard-grid section"><aside class="card sidebar"><nav><button class="active" data-view="orders">Bestellungen</button><button data-view="customers">Kunden</button><button data-view="new-order">Neue Bestellung</button></nav></aside><section>
<div id="view-orders" class="admin-view"><div class="card"><div style="display:flex;justify-content:space-between;align-items:center"><h2>Bestellungen</h2><button class="btn btn-secondary btn-small" id="refreshOrders">Aktualisieren</button></div><div class="table-wrap"><table><thead><tr><th>Nummer</th><th>Kunde</th><th>Leistung</th><th>Status</th><th>Aktion</th></tr></thead><tbody id="ordersTable"></tbody></table></div></div><div id="orderEditor"></div></div>
<div id="view-customers" class="admin-view hidden"><div class="card"><h2>Identity-Benutzer</h2><div class="table-wrap"><table><thead><tr><th>E-Mail</th><th>ID</th><th>Rollen</th></tr></thead><tbody id="customersTable"></tbody></table></div></div></div>
<div id="view-new-order" class="admin-view hidden"><form class="card" id="newOrderForm"><h2>Neue Bestellung</h2><div class="form-grid"><div class="field field-full"><label>Kunde *</label><select id="newCustomer" required></select></div><div class="field"><label>Leistung *</label><input id="newPackage" required></div><div class="field"><label>Status</label><select id="newStatus"><option value="received">Anfrage eingegangen</option><option value="planning">Termin wird geplant</option><option value="confirmed">Termin bestätigt</option><option value="recorded">Aufnahmen erstellt</option><option value="editing">In Bearbeitung</option><option value="ready">Bereit zum Download</option><option value="completed">Abgeschlossen</option><option value="cancelled">Storniert</option></select></div><div class="field"><label>Wunschdatum</label><input id="newDesiredDate" type="date"></div><div class="field field-full"><label>Nachricht an Kunden</label><textarea id="newAdminMessage"></textarea></div></div><button class="btn btn-primary" type="submit">Bestellung erstellen</button></form></div>
</section></div></main><script src="https://identity.netlify.com/v1/netlify-identity-widget.js"></script><script type="module" src="/assets/js/admin.js"></script></body></html>
```

## `content/news/willkommen.md`
...
Hier veröffentlichen wir künftig Neuigkeiten zu Projekten, neuen Angeboten und besonderen Luftaufnahmen.
```

## `impressum.html`

```html
<!doctype html><html lang="de"><head><meta charset="utf-8"><meta name="viewport" content="width=device-width,initial-scale=1"><title>Impressum | ThurSky</title><link rel="stylesheet" href="/assets/css/style.css"></head><body><header class="site-header"><a class="brand" href="/"><img src="/assets/images/logo.png" alt="ThurSky Logo"><span>ThurSky</span></a></header><main class="page-shell"><article class="card"><h1>Impressum</h1><address>Fabian Nutz<br>Haldenstrasse 10<br>8566 Lippoldswilen<br>Schweiz</address><h2>Kontakt</h2><p>Telefon: +41 71 670 17 76<br>E-Mail: <a href="mailto:dronenshots.kemmental@gmail.com">dronenshots.kemmental@gmail.com</a></p><h2>Haftung</h2><p>Trotz sorgfältiger Kontrolle wird keine Gewähr für Aktualität, Vollständigkeit und Richtigkeit übernommen. Für Inhalte externer Websites wird keine Haftung übernommen.</p><h2>Urheberrecht</h2><p>Die Inhalte dieser Website unterliegen dem schweizerischen Urheberrecht.</p></article></main></body></html>
```
...
<head>
  <meta charset="utf-8">
  <meta name="viewport" content="width=device-width,initial-scale=1">
  <title>ThurSky Drohnenaufnahmen – Luftbilder und Videos im Thurgau</title>
  <meta name="description" content="Drohnenaufnahmen im Thurgau: Luftbilder, Videos, Solar- und Dachaufnahmen sowie Immobilienaufnahmen.">
  <link rel="stylesheet" href="/assets/css/style.css">
</head>
<body>
<header class="site-header">
  <a class="brand" href="/"><img src="/assets/images/logo.png" alt="ThurSky Logo"><span>ThurSky</span></a>
  <button class="menu-toggle" id="menuToggle" aria-label="Menü öffnen">☰</button>
  <nav class="desktop-nav" id="mainNav">
    <a href="#start">Start</a><a href="#leistungen">Leistungen</a><a href="#galerie">Galerie</a><a href="#preise">Preise</a><a href="/news/">News</a><a href="#bestellen">Bestellen</a><a href="#kontakt">Kontakt</a><a href="/konto/">Kundenkonto</a>
  </nav>
</header>
<section class="hero" id="start"><div class="hero-inner"><p class="eyebrow">Drohnenaufnahmen im Thurgau</p><h1>ThurSky</h1><p>Saubere und zuverlässige Luftbilder und Videos – schnell, persönlich und unkompliziert.</p><div class="hero-actions"><a class="btn btn-primary" href="#bestellen">Anfrage starten</a><a class="btn btn-secondary" href="/konto/">Kundenkonto</a></div></div></section>
<main class="page-shell">
  <section class="section grid grid-2">
    <article class="card"><p class="eyebrow">Über ThurSky</p><h2>Ihre Drohnenaufnahme aus dem Thurgau</h2><p>Mit moderner Drohnentechnik erstellen wir Foto- und Videoaufnahmen für Privatpersonen, Landwirtschaft und kleinere Projekte.</p></article>
    <article class="card"><p class="eyebrow">Persönlich</p><h2>Über mich</h2><p>Ich bin Fabian Nutz, Gründer von ThurSky. Besonders wichtig sind mir Zuverlässigkeit, faire Preise, saubere Aufnahmen und schnelle Bearbeitung.</p></article>
  </section>

  <section class="section" id="leistungen"><div class="section-heading"><p class="eyebrow">Angebot</p><h2>Leistungen</h2></div><div class="grid grid-3">
    <article class="card"><h3>Haus & Immobilien</h3><p>Luftbilder und Videos von Einfamilienhäusern, Grundstücken und Immobilien.</p></article>
    <article class="card"><h3>Solar & Dach</h3><p>Übersichtsaufnahmen von Solaranlagen und Dächern zur visuellen Kontrolle.</p></article>
    <article class="card"><h3>Feldübersicht</h3><p>Optische Überflüge und Unterstützung bei der eigenen Feldkontrolle.</p></article>
  </div></section>

  <section class="section" id="galerie"><div class="section-heading"><p class="eyebrow">Einblicke</p><h2>Galerie</h2><p>Lege deine vorhandenen Dateien in <code>assets/images/gallery</code> ab und passe die Dateinamen hier an.</p></div><div class="gallery card">
    <img src="/assets/images/gallery/DJI_0005.JPG" alt="Drohnenaufnahme" loading="lazy">
    <img src="/assets/images/gallery/DJI_0006.JPG" alt="Drohnenaufnahme" loading="lazy">
    <img src="/assets/images/gallery/DJI_0008.JPG" alt="Drohnenaufnahme" loading="lazy">
  </div></section>

  <section class="section" id="preise"><div class="section-heading"><p class="eyebrow">Transparent</p><h2>Preise</h2></div><div class="card"><div class="price-row"><span>5 Luftbilder</span><strong>10 CHF</strong></div><div class="price-row"><span>Video</span><strong>15 CHF</strong></div><div class="price-row"><span>Foto + Video</span><strong>20 CHF</strong></div><div class="price-row"><span>Solarcheck</span><strong>20 CHF</strong></div><div class="price-row"><span>Feldkontrolle pro 60 Minuten</span><strong>25 CHF</strong></div></div></section>

  <section class="section" id="bestellen"><div class="section-heading"><p class="eyebrow">Anfrage</p><h2>Bestellung anfragen</h2><p>Zum Schutz deiner Bestellhistorie meldest du dich zuerst an. Danach wird die Anfrage direkt deinem Kundenkonto zugeordnet.</p></div><form class="card" id="orderForm">
    <div id="orderLoginNotice" class="notice">Bitte melde dich an, bevor du die Anfrage sendest.</div>
    <div class="form-grid">
      <div class="field"><label for="package">Leistung *</label><select id="package" required><option value="">Bitte wählen</option><option>5 Luftbilder</option><option>Video</option><option>Foto + Video</option><option>Solarcheck</option><option>Feldkontrolle</option></select></div>
      <div class="field"><label for="desiredDate">Wunschdatum</label><input id="desiredDate" type="date"></div>
      <div class="field"><label for="street">Strasse *</label><input id="street" required minlength="3"></div>
      <div class="field"><label for="postalCode">PLZ *</label><input id="postalCode" required pattern="[0-9]{4}"></div>
      <div class="field"><label for="city">Ort *</label><input id="city" required minlength="2"></div>
      <div class="field field-full"><label for="message">Nachricht</label><textarea id="message" rows="5"></textarea></div>
    </div>
    <div class="hero-actions" style="justify-content:flex-start"><button class="btn btn-secondary" type="button" id="loginForOrder">Anmelden</button><button class="btn btn-primary" type="submit">Anfrage senden</button></div><div id="orderResult"></div>
  </form></section>

  <section class="section" id="kontakt"><div class="section-heading"><p class="eyebrow">Kontakt</p><h2>Kontakt</h2></div><div class="card"><p><strong>E-Mail:</strong> <a href="mailto:dronenshots.kemmental@gmail.com">dronenshots.kemmental@gmail.com</a><br><strong>Telefon:</strong> 071 670 17 76<br><strong>Region:</strong> Thurgau / Kemmental</p></div></section>
</main>
<footer class="site-footer">ThurSky © <span id="year"></span> · <a href="/impressum.html" style="color:white">Impressum</a></footer>
<script src="https://identity.netlify.com/v1/netlify-identity-widget.js"></script>
...
```html
<!doctype html><html lang="de"><head><meta charset="utf-8"><meta name="viewport" content="width=device-width,initial-scale=1"><meta name="robots" content="noindex,nofollow"><title>Kundenkonto | ThurSky</title><link rel="stylesheet" href="/assets/css/style.css"></head><body>
<header class="site-header"><a class="brand" href="/"><img src="/assets/images/logo.png" alt="ThurSky Logo"><span>ThurSky</span></a><nav class="desktop-nav"><a href="/">Website</a><button class="nav-button" id="logoutButton">Abmelden</button></nav></header>
<main class="page-shell"><section class="hero-small"><p class="eyebrow">Geschützter Bereich</p><h1>Mein Kundenkonto</h1><p id="welcomeText">Anmeldung wird geprüft …</p></section><div id="accountMessage"></div><section class="section"><div class="section-heading"><h2>Meine Bestellungen</h2></div><div id="ordersContainer" class="grid"><div class="card"><div class="spinner"></div></div></div></section></main>
<script src="https://identity.netlify.com/v1/netlify-identity-widget.js"></script><script type="module" src="/assets/js/customer.js"></script></body></html>
```
...
## `netlify/functions/_shared/orders.mjs`
...
## `netlify/functions/_shared/supabase.mjs`
...
## `netlify/functions/file-complete.mjs`
...
## `netlify/functions/file-download.mjs`
...
## `netlify/functions/file-upload-url.mjs`
...
<title>News | ThurSky</title><meta name="description" content="Aktuelle Neuigkeiten von ThurSky">
...
<main class="page-shell"><section class="hero-small"><p class="eyebrow">Aktuelles</p><h1>News</h1><p>Projekte, Angebote und Einblicke von ThurSky.</p></section><section class="news-grid"><article class="card news-card"><div><p class="eyebrow">15. Juli 2026</p><h2><a href="/news/willkommen/">Willkommen bei ThurSky</a></h2><p>Neuigkeiten, Projekte und Einblicke rund um unsere Drohnenaufnahmen.</p><a class="text-link" href="/news/willkommen/">Weiterlesen</a></div></article></section></main><footer class="site-footer">ThurSky © 2026</footer></body></html>
```

## `news/willkommen/index.html`

```html
<!doctype html>
<html lang="de"><head><meta charset="utf-8"><meta name="viewport" content="width=device-width,initial-scale=1">
<title>Willkommen bei ThurSky | ThurSky</title><meta name="description" content="Neuigkeiten, Projekte und Einblicke rund um unsere Drohnenaufnahmen.">
<link rel="stylesheet" href="/assets/css/style.css"></head><body>
<header class="site-header"><a class="brand" href="/"><img src="/assets/images/logo.png" alt="ThurSky Logo"><span>ThurSky</span></a><nav class="desktop-nav"><a href="/">Start</a><a href="/news/">News</a><a href="/konto/">Kundenkonto</a></nav></header>
<main class="page-shell"><article class="article card"><p class="eyebrow">15. Juli 2026</p><h1>Willkommen bei ThurSky</h1><p class="lead">Neuigkeiten, Projekte und Einblicke rund um unsere Drohnenaufnahmen.</p><div class="article-body"><p>Hier veröffentlichen wir künftig Neuigkeiten zu Projekten, neuen Angeboten und besonderen Luftaufnahmen.</p>
</div><p><a class="text-link" href="/news/">Zurück zu News</a></p></article></main><footer class="site-footer">ThurSky © 2026</footer></body></html>
```
...
```json
{
  ...
  "packages": {
    ...
    "node_modules/netlify-cli/node_modules/@bugsnag/browser": {
      "version": "8.6.0",
      "resolved": "https://registry.npmjs.org/@bugsnag/browser/-/browser-8.6.0.tgz",
      "integrity": "sha512-7UGqTGnQqXUQ09gOlWbDTFUSbeLIIrP+hML3kTOq8Zdc8nP/iuOEflXGLV2TxWBWW8xIUPc928caFPr9EcaDuw==",
      "dev": true,
      "dependencies": {
        "@bugsnag/core": "^8.6.0"
      }
    ...
    "node_modules/netlify-cli/node_modules/@bugsnag/js": {
      "version": "8.6.0",
      "resolved": "https://registry.npmjs.org/@bugsnag/js/-/js-8.6.0.tgz",
      "integrity": "sha512-U+ofNTTMA2Z6tCrOhK/QhHBhLoQHoalk8Y82WWc7FAcVSoJZYadND/QuXUriNRZpC4YgJ/s/AxPeQ2y+WvMxzw==",
      "dev": true,
      "license": "MIT",
      "dependencies": {
    ...
    "node_modules/netlify-cli/node_modules/@bugsnag/node": {
      "version": "8.6.0",
      "resolved": "https://registry.npmjs.org/@bugsnag/node/-/node-8.6.0.tgz",
      "integrity": "sha512-O91sELo6zBjflVeP3roRC9l68iYaafVs5lz2N0FDkrT08mP2UljtNWpjjoR/0h1so5Ny1OxHgnZ1IrsXhz5SMQ==",
      "dev": true,
      "dependencies": {
        "@bugsnag/core": "^8.6.0",
        "byline": "^5.0.0",
    ...
    "node_modules/netlify-cli/node_modules/@cspotcode/source-map-support/node_modules/@jridgewell/trace-mapping": {
      "version": "0.3.9",
    ...
    "node_modules/netlify-cli/node_modules/@emnapi/runtime": {
      "version": "1.5.0",
    ...
    "node_modules/netlify-cli/node_modules/@envelop/instrumentation": {
      "version": "1.0.0",
    ...
    "node_modules/netlify-cli/node_modules/@fastify/busboy": {
      "version": "3.2.0",
    ...
    "node_modules/netlify-cli/node_modules/@fastify/forwarded": {
      "version": "3.0.1",
    ...
    "node_modules/netlify-cli/node_modules/@fastify/proxy-addr": {
      "version": "5.1.0",
    ...
    "node_modules/netlify-cli/node_modules/@fastify/proxy-addr/node_modules/ipaddr.js": {
      "version": "2.3.0",
    ...
    "node_modules/netlify-cli/node_modules/@fastify/static/node_modules/content-disposition": {
      "version": "1.0.1",
    ...
    "node_modules/netlify-cli/node_modules/@fastify/static/node_modules/lru-cache": {
      "version": "11.2.5",
    ...
    "node_modules/netlify-cli/node_modules/@fastify/static/node_modules/path-scurry": {
      "version": "2.0.1",
    ...
    "node_modules/netlify-cli/node_modules/@img/colour": {
      "version": "1.0.0",
    ...
    "node_modules/netlify-cli/node_modules/@img/sharp-darwin-arm64": {
      "version": "0.34.4",
    ...
    "node_modules/netlify-cli/node_modules/@img/sharp-darwin-x64": {
      "version": "0.34.4",
    ...
    "node_modules/netlify-cli/node_modules/@img/sharp-libvips-darwin-arm64": {
      "version": "1.2.3",
    ...
    "node_modules/netlify-cli/node_modules/@img/sharp-libvips-darwin-x64": {
      "version": "1.2.3",
    ...
    "node_modules/netlify-cli/node_modules/@img/sharp-libvips-linux-arm": {
      "version": "1.2.3",
    ...
    "node_modules/netlify-cli/node_modules/@img/sharp-libvips-linux-arm64": {
      "version": "1.2.3",
    ...
    "node_modules/netlify-cli/node_modules/@img/sharp-libvips-linux-ppc64": {
      "version": "1.2.3",
    ...
    "node_modules/netlify-cli/node_modules/@img/sharp-libvips-linux-s390x": {
      "version": "1.2.3",
    ...
    "node_modules/netlify-cli/node_modules/@img/sharp-libvips-linux-x64": {
      "version": "1.2.3",
    ...
    "node_modules/netlify-cli/node_modules/@img/sharp-libvips-linuxmusl-arm64": {
      "version": "1.2.3",
    ...
    "node_modules/netlify-cli/node_modules/@img/sharp-libvips-linuxmusl-x64": {
      "version": "1.2.3",
    ...
    "node_modules/netlify-cli/node_modules/@img/sharp-linux-arm": {
      "version": "0.34.4",
    ...
    "node_modules/netlify-cli/node_modules/@img/sharp-linux-arm64": {
      "version": "0.34.4",
    ...
    "node_modules/netlify-cli/node_modules/@img/sharp-linux-ppc64": {
      "version": "0.34.4",
    ...
    "node_modules/netlify-cli/node_modules/@img/sharp-linux-s390x": {
      "version": "0.34.4",
    ...
    "node_modules/netlify-cli/node_modules/@img/sharp-linux-x64": {
      "version": "0.34.4",
    ...
    "node_modules/netlify-cli/node_modules/@img/sharp-linuxmusl-arm64": {
      "version": "0.34.4",
    ...
    "node_modules/netlify-cli/node_modules/@img/sharp-linuxmusl-x64": {
      "version": "0.34.4",
    ...
    "node_modules/netlify-cli/node_modules/@img/sharp-wasm32": {
      "version": "0.34.4",
    ...
    "node_modules/netlify-cli/node_modules/@img/sharp-win32-arm64": {
      "version": "0.34.4",
    ...
    "node_modules/netlify-cli/node_modules/@img/sharp-win32-ia32": {
      "version": "0.34.4",
    ...
    "node_modules/netlify-cli/node_modules/@img/sharp-win32-x64": {
      "version": "0.34.4",
    ...
    "node_modules/netlify-cli/node_modules/@isaacs/balanced-match": {
      "version": "4.0.1",
    ...
    "node_modules/netlify-cli/node_modules/@isaacs/brace-expansion": {
      "version": "5.0.1",
    ...
    "node_modules/netlify-cli/node_modules/@isaacs/fs-minipass": {
      "version": "4.0.1",
    ...
    "node_modules/netlify-cli/node_modules/@netlify/api/node_modules/p-timeout": {
      "version": "6.1.4",
    ...
    "node_modules/netlify-cli/node_modules/@netlify/api/node_modules/p-wait-for": {
      "version": "5.0.2",
    ...
    "node_modules/netlify-cli/node_modules/@netlify/blobs": {
      "version": "10.1.0",
      "resolved": "https://registry.npmjs.org/@netlify/blobs/-/blobs-10.1.0.tgz",
      "integrity": "sha512-dFpqDc6/x5LEu9L7kblCQu00CFEchH8J42jmQoXPuhKoE7avajzeLTbVKA8Olk3S/c2m9ejegrgbhL8NRA2Jyw==",
      "dev": true,
      "license": "MIT",
      "dependencies": {
    ...
    "node_modules/netlify-cli/node_modules/@netlify/blobs/node_modules/@netlify/dev-utils": {
      "version": "4.3.0",
      "resolved": "https://registry.npmjs.org/@netlify/dev-utils/-/dev-utils-4.3.0.tgz",
      "integrity": "sha512-vZAL8pMuj3yPQlmHSgyaA/UQFxc6pZgU0LucFJ1+IPWGJtIzBXHRvuR4acpoP72HtyQPUHJ42s7U9GaaSGVNHg==",
      "dev": true,
      "license": "MIT",
      "dependencies": {
    ...
    "node_modules/netlify-cli/node_modules/@netlify/blobs/node_modules/dot-prop": {
      "version": "9.0.0",
    ...
    "node_modules/netlify-cli/node_modules/@netlify/blobs/node_modules/env-paths": {
      "version": "3.0.0",
    ...
    "node_modules/netlify-cli/node_modules/@netlify/blobs/node_modules/uuid": {
      "version": "11.1.0",
    ...
    "node_modules/netlify-cli/node_modules/@netlify/build": {
      "version": "35.5.14",
      "resolved": "https://registry.npmjs.org/@netlify/build/-/build-35.5.14.tgz",
      "integrity": "sha512-HL0p3HKUTuwqJtIklNdZlrUdZ0SwhAGQei5p5t9nXp8Wk0Z+EyFMFVQronCdsbplP1x1XTqW/1T3HiWChzXHdQ==",
      "dev": true,
      "license": "MIT",
      "dependencies": {
        "@bugsnag/js": "^8.0.0",
    ...
    "node_modules/netlify-cli/node_modules/@netlify/build-info": {
      "version": "10.3.0",
      "resolved": "https://registry.npmjs.org/@netlify/build-info/-/build-info-10.3.0.tgz",
      "integrity": "sha512-5cS0LPGMrdSg1lqVCoHd5qqyTMEhjb7HEj76i95bYCJ3ruiYKVeJ/hYk4aJBXBGIadBgkOGYpoe/sgEKsobIeA==",
      "dev": true,
      "license": "MIT",
      "dependencies": {
        "@bugsnag/js": "^8.0.0",
    ...
    "node_modules/netlify-cli/node_modules/@netlify/build/node_modules/@netlify/blobs": {
      "version": "10.5.0",
      "resolved": "https://registry.npmjs.org/@netlify/blobs/-/blobs-10.5.0.tgz",
      "integrity": "sha512-yrdt6H1X56DYz7pS3exU/iHO+iOW5sVzseaQwRQQ9OYChB/pVjXQzkBKAjS9dHIecSpv0oynkLxd/mwSJfAJLQ==",
      "dev": true,
      "license": "MIT",
      "dependencies": {
    ...
    "node_modules/netlify-cli/node_modules/@netlify/build/node_modules/@netlify/dev-utils": {
      "version": "4.3.3",
      "resolved": "https://registry.npmjs.org/@netlify/dev-utils/-/dev-utils-4.3.3.tgz",
      "integrity": "sha512-qziF8R9kf7mRNgSpmUH96O0aV1ZiwK4c9ZecFQbDSQuYhgy9GY1WTjiQF0oQnohjTjWNtXhrU39LAeXWNLaBJg==",
      "dev": true,
      "license": "MIT",
      "dependencies": {
        "@whatwg-node/server": "^0.10.0",
    ...
    "node_modules/netlify-cli/node_modules/@netlify/build/node_modules/@netlify/dev-utils/node_modules/uuid": {
      "version": "13.0.0",
    ...
    "node_modules/netlify-cli/node_modules/@netlify/build/node_modules/@netlify/runtime-utils": {
      "version": "2.2.1",
      "resolved": "https://registry.npmjs.org/@netlify/runtime-utils/-/runtime-utils-2.2.1.tgz",
      "integrity": "sha512-dyJeuggzQM8+Dsi0T8Z9UjfLJ6vCmNC36W6WE2aqzfTdTw4wPkh2xlEu4LoD75+TGuYK7jIhEoU2QcCXOzfyAQ==",
      "dev": true,
      "license": "MIT",
      "engines": {
        "node": "^18.14.0 || >=20"
    ...
    "node_modules/netlify-cli/node_modules/@netlify/build/node_modules/@sindresorhus/slugify": {
      "version": "2.2.1",
    ...
    "node_modules/netlify-cli/node_modules/@netlify/build/node_modules/dot-prop": {
      "version": "9.0.0",
      "resolved": "https://registry.npmjs.org/dot-prop/-/dot-prop-9.0.0.tgz",
      "integrity": "sha512-1gxPBJpI/pcjQhKgIU91II6Wkay+dLcN3M6rf2uwP8hRur3HtQXjVrdAK3sjC0piaEuxzMwjXChcETiJl47lAQ==",
      "dev": true,
    ...
    "node_modules/netlify-cli/node_modules/@netlify/build/node_modules/env-paths": {
      "version": "3.0.0",
      "resolved": "https://registry.npmjs.org/env-paths/-/env-paths-3.0.0.tgz",
      "integrity": "sha512-dtJUTepzMW3Lm/NPxRf3wP4642UWhjL2sQxc+ym2YMj1m/H2zDNQOlezafzkHwn6sMstjHTwG6iQQsctDW/b1A==",
      "dev": true,
    ...
    "node_modules/netlify-cli/node_modules/@netlify/build/node_modules/get-stream": {
      "version": "8.0.1",
    ...
    "node_modules/netlify-cli/node_modules/@netlify/build/node_modules/read-package-up": {
      "version": "11.0.0",
    ...
    "node_modules/netlify-cli/node_modules/@netlify/build/node_modules/signal-exit": {
      "version": "4.1.0",
    ...
    "node_modules/netlify-cli/node_modules/@netlify/build/node_modules/uuid": {
      "version": "11.1.0",
      "resolved": "https://registry.npmjs.org/uuid/-/uuid-11.1.0.tgz",
      "integrity": "sha512-0/A9rDy9P7cJ+8w1c9WD9V//9Wj15Ce2MPz8Ri6032usz+NfePxx5AcN3bN+r6ZL6jEo066/yNYB3tn4pQEx+A==",
      "dev": true,
    ...
    "node_modules/netlify-cli/node_modules/@netlify/config/node_modules/get-stream": {
      "version": "8.0.1",
      "resolved": "https://registry.npmjs.org/get-stream/-/get-stream-8.0.1.tgz",
      "integrity": "sha512-VaUJspBffn/LMCJVoMvSAdmscJyS1auj5Zulnn5UoYcY531UWmdwhRWkcGKnGU93m5HSXP9LP2usOryrBtQowA==",
      "dev": true,
    ...
    "node_modules/netlify-cli/node_modules/@netlify/config/node_modules/read-package-up": {
      "version": "11.0.0",
      "resolved": "https://registry.npmjs.org/read-package-up/-/read-package-up-11.0.0.tgz",
      "integrity": "sha512-MbgfoNPANMdb4oRBNg5eqLbB2t2r+o5Ua1pNt8BqGp4I0FJZhuVSOj3PaBPni4azWuSzEdNn2evevzVmEk1ohQ==",
      "dev": true,
    ...
    "node_modules/netlify-cli/node_modules/@netlify/config/node_modules/signal-exit": {
      "version": "4.1.0",
      "resolved": "https://registry.npmjs.org/signal-exit/-/signal-exit-4.1.0.tgz",
      "integrity": "sha512-bzyZ1e88w9O1iNJbKnOlvYTrWPDl46O1bG0D3XInv+9tkPrxrN8jUUTiFlDkkmKWgn1M6CfIA13SuGqOa9Korw==",
      "dev": true,
    ...
    "node_modules/netlify-cli/node_modules/@netlify/dev-utils": {
      "version": "4.3.2",
      "resolved": "https://registry.npmjs.org/@netlify/dev-utils/-/dev-utils-4.3.2.tgz",
      "integrity": "sha512-Nl6c5UVLbpOwvzVaT6fJycdkc3EswqFoI9c2hZ3WUUX+kQ2ojdrkFMuKcPERaGXYxrhy/uGk1CURAflG8YC2RA==",
      "dev": true,
      "license": "MIT",
      "dependencies": {
        "@whatwg-node/server": "^0.10.0",
    ...
    "node_modules/netlify-cli/node_modules/@netlify/dev-utils/node_modules/dot-prop": {
      "version": "9.0.0",
      "resolved": "https://registry.npmjs.org/dot-prop/-/dot-prop-9.0.0.tgz",
      "integrity": "sha512-1gxPBJpI/pcjQhKgIU91II6Wkay+dLcN3M6rf2uwP8hRur3HtQXjVrdAK3sjC0piaEuxzMwjXChcETiJl47lAQ==",
      "dev": true,
    ...
    "node_modules/netlify-cli/node_modules/@netlify/dev-utils/node_modules/env-paths": {
      "version": "3.0.0",
      "resolved": "https://registry.npmjs.org/env-paths/-/env-paths-3.0.0.tgz",
      "integrity": "sha512-dtJUTepzMW3Lm/NPxRf3wP4642UWhjL2sQxc+ym2YMj1m/H2zDNQOlezafzkHwn6sMstjHTwG6iQQsctDW/b1A==",
      "dev": true,
    ...
    "node_modules/netlify-cli/node_modules/@netlify/edge-bundler": {
      "version": "14.9.5",
      "resolved": "https://registry.npmjs.org/@netlify/edge-bundler/-/edge-bundler-14.9.5.tgz",
      "integrity": "sha512-0VSItMmQw2hfBpVL6puaEgJ7GM0GIp7/W1UYOAvYDP1OA/X5ri0T+nFmBKFLRWtjV335mxc8xOpQhEo0OWqdMg==",
      "dev": true,
      "license": "MIT",
      "dependencies": {
    ...
    "node_modules/netlify-cli/node_modules/@netlify/edge-bundler/node_modules/@esbuild/netbsd-arm64": {
      "version": "0.27.2",
    ...
    "node_modules/netlify-cli/node_modules/@netlify/edge-bundler/node_modules/@esbuild/openbsd-arm64": {
      "version": "0.27.2",
    ...
    "node_modules/netlify-cli/node_modules/@netlify/edge-bundler/node_modules/@esbuild/openharmony-arm64": {
      "version": "0.27.2",
    ...
    "node_modules/netlify-cli/node_modules/@netlify/edge-bundler/node_modules/env-paths": {
      "version": "3.0.0",
      "resolved": "https://registry.npmjs.org/env-paths/-/env-paths-3.0.0.tgz",
      "integrity": "sha512-dtJUTepzMW3Lm/NPxRf3wP4642UWhjL2sQxc+ym2YMj1m/H2zDNQOlezafzkHwn6sMstjHTwG6iQQsctDW/b1A==",
      "dev": true,
    ...
    "node_modules/netlify-cli/node_modules/@netlify/edge-bundler/node_modules/get-stream": {
      "version": "8.0.1",
      "resolved": "https://registry.npmjs.org/get-stream/-/get-stream-8.0.1.tgz",
      "integrity": "sha512-VaUJspBffn/LMCJVoMvSAdmscJyS1auj5Zulnn5UoYcY531UWmdwhRWkcGKnGU93m5HSXP9LP2usOryrBtQowA==",
      "dev": true,
    ...
    "node_modules/netlify-cli/node_modules/@netlify/edge-bundler/node_modules/signal-exit": {
      "version": "4.1.0",
      "resolved": "https://registry.npmjs.org/signal-exit/-/signal-exit-4.1.0.tgz",
      "integrity": "sha512-bzyZ1e88w9O1iNJbKnOlvYTrWPDl46O1bG0D3XInv+9tkPrxrN8jUUTiFlDkkmKWgn1M6CfIA13SuGqOa9Korw==",
      "dev": true,
    ...
    "node_modules/netlify-cli/node_modules/@netlify/edge-bundler/node_modules/uuid": {
      "version": "11.1.0",
      "resolved": "https://registry.npmjs.org/uuid/-/uuid-11.1.0.tgz",
      "integrity": "sha512-0/A9rDy9P7cJ+8w1c9WD9V//9Wj15Ce2MPz8Ri6032usz+NfePxx5AcN3bN+r6ZL6jEo066/yNYB3tn4pQEx+A==",
      "dev": true,
    ...
    "node_modules/netlify-cli/node_modules/@netlify/edge-functions-bootstrap": {
      "version": "2.17.1",
    ...
    "node_modules/netlify-cli/node_modules/@netlify/edge-functions/node_modules/@netlify/types": {
      "version": "2.3.0",
    ...
    "node_modules/netlify-cli/node_modules/@netlify/git-utils": {
      "version": "6.0.3",
      "resolved": "https://registry.npmjs.org/@netlify/git-utils/-/git-utils-6.0.3.tgz",
      "integrity": "sha512-f6zGgGaIL0/wsraqa1wraFFuv1kY6FqDtz9elPWsXVQpLMS/T6/rc5Qr7RT1FezUobA6XdspLJ+mTpIo2VNSzg==",
      "dev": true,
      "license": "MIT",
      "dependencies": {
        "execa": "^8.0.0",
    ...
    "node_modules/netlify-cli/node_modules/@netlify/git-utils/node_modules/get-stream": {
      "version": "8.0.1",
      "resolved": "https://registry.npmjs.org/get-stream/-/get-stream-8.0.1.tgz",
      "integrity": "sha512-VaUJspBffn/LMCJVoMvSAdmscJyS1auj5Zulnn5UoYcY531UWmdwhRWkcGKnGU93m5HSXP9LP2usOryrBtQowA==",
      "dev": true,
    ...
    "node_modules/netlify-cli/node_modules/@netlify/git-utils/node_modules/signal-exit": {
      "version": "4.1.0",
      "resolved": "https://registry.npmjs.org/signal-exit/-/signal-exit-4.1.0.tgz",
      "integrity": "sha512-bzyZ1e88w9O1iNJbKnOlvYTrWPDl46O1bG0D3XInv+9tkPrxrN8jUUTiFlDkkmKWgn1M6CfIA13SuGqOa9Korw==",
      "dev": true,
    ...
    "node_modules/netlify-cli/node_modules/@netlify/images": {
      "version": "1.2.5",
    ...
    "node_modules/netlify-cli/node_modules/@netlify/otel": {
      "version": "5.1.1",
      "resolved": "https://registry.npmjs.org/@netlify/otel/-/otel-5.1.1.tgz",
      "integrity": "sha512-WCSlOsd0a0Vn+iPC5PYru7rq/5/QpBGnvam6C7cq9DEiTFqfwExNoxk6SWI0T6nI56gkBryaGsENLTEnUue1lg==",
      "dev": true,
      "license": "MIT",
      "dependencies": {
    ...
    "node_modules/netlify-cli/node_modules/@netlify/otel/node_modules/@opentelemetry/api": {
      "version": "1.9.0",
    ...
    "node_modules/netlify-cli/node_modules/@netlify/run-utils/node_modules/get-stream": {
      "version": "8.0.1",
      "resolved": "https://registry.npmjs.org/get-stream/-/get-stream-8.0.1.tgz",
      "integrity": "sha512-VaUJspBffn/LMCJVoMvSAdmscJyS1auj5Zulnn5UoYcY531UWmdwhRWkcGKnGU93m5HSXP9LP2usOryrBtQowA==",
      "dev": true,
    ...
    "node_modules/netlify-cli/node_modules/@netlify/run-utils/node_modules/signal-exit": {
      "version": "4.1.0",
      "resolved": "https://registry.npmjs.org/signal-exit/-/signal-exit-4.1.0.tgz",
      "integrity": "sha512-bzyZ1e88w9O1iNJbKnOlvYTrWPDl46O1bG0D3XInv+9tkPrxrN8jUUTiFlDkkmKWgn1M6CfIA13SuGqOa9Korw==",
      "dev": true,
    ...
    "node_modules/netlify-cli/node_modules/@netlify/runtime-utils": {
      "version": "2.2.0",
      "resolved": "https://registry.npmjs.org/@netlify/runtime-utils/-/runtime-utils-2.2.0.tgz",
      "integrity": "sha512-K3kWIxIMucibzQsATU2xw2JI+OpS9PZfPW/a+81gmeLC8tLv5YAxTVT0NFY/3imk1kcOJb9g7658jPLqDJaiAw==",
      "dev": true,
      "license": "MIT",
      "engines": {
        "node": "^18.14.0 || >=20"
    ...
    "node_modules/netlify-cli/node_modules/@netlify/serverless-functions-api": {
      "version": "2.8.3",
      "resolved": "https://registry.npmjs.org/@netlify/serverless-functions-api/-/serverless-functions-api-2.8.3.tgz",
    ...
    "node_modules/netlify-cli/node_modules/@netlify/zip-it-and-ship-it/node_modules/@esbuild/aix-ppc64": {
      "version": "0.27.2",
      "resolved": "https://registry.npmjs.org/@esbuild/aix-ppc64/-/aix-ppc64-0.27.2.tgz",
      "integrity": "sha512-GZMB+a0mOMZs4MpDbj8RJp4cw+w1WV5NYD6xzgvzUJ5Ek2jerwfO2eADyI6ExDSUED+1X8aMbegahsJi+8mgpw==",
      "cpu": [
    ...
    "node_modules/netlify-cli/node_modules/@netlify/zip-it-and-ship-it/node_modules/@esbuild/android-arm": {
      "version": "0.27.2",
      "resolved": "https://registry.npmjs.org/@esbuild/android-arm/-/android-arm-0.27.2.tgz",
      "integrity": "sha512-DVNI8jlPa7Ujbr1yjU2PfUSRtAUZPG9I1RwW4F4xFB1Imiu2on0ADiI/c3td+KmDtVKNbi+nffGDQMfcIMkwIA==",
      "cpu": [
    ...
    "node_modules/netlify-cli/node_modules/@netlify/zip-it-and-ship-it/node_modules/@esbuild/android-arm64": {
      "version": "0.27.2",
      "resolved": "https://registry.npmjs.org/@esbuild/android-arm64/-/android-arm64-0.27.2.tgz",
      "integrity": "sha512-pvz8ZZ7ot/RBphf8fv60ljmaoydPU12VuXHImtAs0XhLLw+EXBi2BLe3OYSBslR4rryHvweW5gmkKFwTiFy6KA==",
      "cpu": [
    ...
    "node_modules/netlify-cli/node_modules/@netlify/zip-it-and-ship-it/node_modules/@esbuild/android-x64": {
      "version": "0.27.2",
      "resolved": "https://registry.npmjs.org/@esbuild/android-x64/-/android-x64-0.27.2.tgz",
      "integrity": "sha512-z8Ank4Byh4TJJOh4wpz8g2vDy75zFL0TlZlkUkEwYXuPSgX8yzep596n6mT7905kA9uHZsf/o2OJZubl2l3M7A==",
      "cpu": [
    ...
    "node_modules/netlify-cli/node_modules/@netlify/zip-it-and-ship-it/node_modules/@esbuild/darwin-arm64": {
      "version": "0.27.2",
      "resolved": "https://registry.npmjs.org/@esbuild/darwin-arm64/-/darwin-arm64-0.27.2.tgz",
      "integrity": "sha512-davCD2Zc80nzDVRwXTcQP/28fiJbcOwvdolL0sOiOsbwBa72kegmVU0Wrh1MYrbuCL98Omp5dVhQFWRKR2ZAlg==",
      "cpu": [
    ...
    "node_modules/netlify-cli/node_modules/@netlify/zip-it-and-ship-it/node_modules/@esbuild/darwin-x64": {
      "version": "0.27.2",
      "resolved": "https://registry.npmjs.org/@esbuild/darwin-x64/-/darwin-x64-0.27.2.tgz",
      "integrity": "sha512-ZxtijOmlQCBWGwbVmwOF/UCzuGIbUkqB1faQRf5akQmxRJ1ujusWsb3CVfk/9iZKr2L5SMU5wPBi1UWbvL+VQA==",
      "cpu": [
    ...
    "node_modules/netlify-cli/node_modules/@netlify/zip-it-and-ship-it/node_modules/@esbuild/freebsd-arm64": {
      "version": "0.27.2",
      "resolved": "https://registry.npmjs.org/@esbuild/freebsd-arm64/-/freebsd-arm64-0.27.2.tgz",
      "integrity": "sha512-lS/9CN+rgqQ9czogxlMcBMGd+l8Q3Nj1MFQwBZJyoEKI50XGxwuzznYdwcav6lpOGv5BqaZXqvBSiB/kJ5op+g==",
      "cpu": [
    ...
    "node_modules/netlify-cli/node_modules/@netlify/zip-it-and-ship-it/node_modules/@esbuild/freebsd-x64": {
      "version": "0.27.2",
      "resolved": "https://registry.npmjs.org/@esbuild/freebsd-x64/-/freebsd-x64-0.27.2.tgz",
      "integrity": "sha512-tAfqtNYb4YgPnJlEFu4c212HYjQWSO/w/h/lQaBK7RbwGIkBOuNKQI9tqWzx7Wtp7bTPaGC6MJvWI608P3wXYA==",
      "cpu": [
    ...
    "node_modules/netlify-cli/node_modules/@netlify/zip-it-and-ship-it/node_modules/@esbuild/linux-arm": {
      "version": "0.27.2",
      "resolved": "https://registry.npmjs.org/@esbuild/linux-arm/-/linux-arm-0.27.2.tgz",
      "integrity": "sha512-vWfq4GaIMP9AIe4yj1ZUW18RDhx6EPQKjwe7n8BbIecFtCQG4CfHGaHuh7fdfq+y3LIA2vGS/o9ZBGVxIDi9hw==",
      "cpu": [
    ...
    "node_modules/netlify-cli/node_modules/@netlify/zip-it-and-ship-it/node_modules/@esbuild/linux-arm64": {
      "version": "0.27.2",
      "resolved": "https://registry.npmjs.org/@esbuild/linux-arm64/-/linux-arm64-0.27.2.tgz",
      "integrity": "sha512-hYxN8pr66NsCCiRFkHUAsxylNOcAQaxSSkHMMjcpx0si13t1LHFphxJZUiGwojB1a/Hd5OiPIqDdXONia6bhTw==",
      "cpu": [
    ...
    "node_modules/netlify-cli/node_modules/@netlify/zip-it-and-ship-it/node_modules/@esbuild/linux-ia32": {
      "version": "0.27.2",
      "resolved": "https://registry.npmjs.org/@esbuild/linux-ia32/-/linux-ia32-0.27.2.tgz",
      "integrity": "sha512-MJt5BRRSScPDwG2hLelYhAAKh9imjHK5+NE/tvnRLbIqUWa+0E9N4WNMjmp/kXXPHZGqPLxggwVhz7QP8CTR8w==",
      "cpu": [
    ...
    "node_modules/netlify-cli/node_modules/@netlify/zip-it-and-ship-it/node_modules/@esbuild/linux-loong64": {
      "version": "0.27.2",
      "resolved": "https://registry.npmjs.org/@esbuild/linux-loong64/-/linux-loong64-0.27.2.tgz",
      "integrity": "sha512-lugyF1atnAT463aO6KPshVCJK5NgRnU4yb3FUumyVz+cGvZbontBgzeGFO1nF+dPueHD367a2ZXe1NtUkAjOtg==",
      "cpu": [
    ...
    "node_modules/netlify-cli/node_modules/@netlify/zip-it-and-ship-it/node_modules/@esbuild/linux-mips64el": {
      "version": "0.27.2",
      "resolved": "https://registry.npmjs.org/@esbuild/linux-mips64el/-/linux-mips64el-0.27.2.tgz",
      "integrity": "sha512-nlP2I6ArEBewvJ2gjrrkESEZkB5mIoaTswuqNFRv/WYd+ATtUpe9Y09RnJvgvdag7he0OWgEZWhviS1OTOKixw==",
      "cpu": [
    ...
    "node_modules/netlify-cli/node_modules/@netlify/zip-it-and-ship-it/node_modules/@esbuild/linux-ppc64": {
      "version": "0.27.2",
      "resolved": "https://registry.npmjs.org/@esbuild/linux-ppc64/-/linux-ppc64-0.27.2.tgz",
      "integrity": "sha512-C92gnpey7tUQONqg1n6dKVbx3vphKtTHJaNG2Ok9lGwbZil6DrfyecMsp9CrmXGQJmZ7iiVXvvZH6Ml5hL6XdQ==",
      "cpu": [
    ...
    "node_modules/netlify-cli/node_modules/@netlify/zip-it-and-ship-it/node_modules/@esbuild/linux-riscv64": {
      "version": "0.27.2",
      "resolved": "https://registry.npmjs.org/@esbuild/linux-riscv64/-/linux-riscv64-0.27.2.tgz",
      "integrity": "sha512-B5BOmojNtUyN8AXlK0QJyvjEZkWwy/FKvakkTDCziX95AowLZKR6aCDhG7LeF7uMCXEJqwa8Bejz5LTPYm8AvA==",
      "cpu": [
    ...
    "node_modules/netlify-cli/node_modules/@netlify/zip-it-and-ship-it/node_modules/@esbuild/linux-s390x": {
      "version": "0.27.2",
      "resolved": "https://registry.npmjs.org/@esbuild/linux-s390x/-/linux-s390x-0.27.2.tgz",
      "integrity": "sha512-p4bm9+wsPwup5Z8f4EpfN63qNagQ47Ua2znaqGH6bqLlmJ4bx97Y9JdqxgGZ6Y8xVTixUnEkoKSHcpRlDnNr5w==",
      "cpu": [
    ...
    "node_modules/netlify-cli/node_modules/@netlify/zip-it-and-ship-it/node_modules/@esbuild/linux-x64": {
      "version": "0.27.2",
      "resolved": "https://registry.npmjs.org/@esbuild/linux-x64/-/linux-x64-0.27.2.tgz",
      "integrity": "sha512-uwp2Tip5aPmH+NRUwTcfLb+W32WXjpFejTIOWZFw/v7/KnpCDKG66u4DLcurQpiYTiYwQ9B7KOeMJvLCu/OvbA==",
      "cpu": [
    ...
    "node_modules/netlify-cli/node_modules/@netlify/zip-it-and-ship-it/node_modules/@esbuild/netbsd-arm64": {
      "version": "0.27.2",
      "resolved": "https://registry.npmjs.org/@esbuild/netbsd-arm64/-/netbsd-arm64-0.27.2.tgz",
      "integrity": "sha512-Kj6DiBlwXrPsCRDeRvGAUb/LNrBASrfqAIok+xB0LxK8CHqxZ037viF13ugfsIpePH93mX7xfJp97cyDuTZ3cw==",
      "cpu": [
    ...
    "node_modules/netlify-cli/node_modules/@netlify/zip-it-and-ship-it/node_modules/@esbuild/netbsd-x64": {
      "version": "0.27.2",
      "resolved": "https://registry.npmjs.org/@esbuild/netbsd-x64/-/netbsd-x64-0.27.2.tgz",
      "integrity": "sha512-HwGDZ0VLVBY3Y+Nw0JexZy9o/nUAWq9MlV7cahpaXKW6TOzfVno3y3/M8Ga8u8Yr7GldLOov27xiCnqRZf0tCA==",
      "cpu": [
    ...
    "node_modules/netlify-cli/node_modules/@netlify/zip-it-and-ship-it/node_modules/@esbuild/openbsd-arm64": {
      "version": "0.27.2",
      "resolved": "https://registry.npmjs.org/@esbuild/openbsd-arm64/-/openbsd-arm64-0.27.2.tgz",
      "integrity": "sha512-DNIHH2BPQ5551A7oSHD0CKbwIA/Ox7+78/AWkbS5QoRzaqlev2uFayfSxq68EkonB+IKjiuxBFoV8ESJy8bOHA==",
      "cpu": [
    ...
    "node_modules/netlify-cli/node_modules/@netlify/zip-it-and-ship-it/node_modules/@esbuild/openbsd-x64": {
      "version": "0.27.2",
      "resolved": "https://registry.npmjs.org/@esbuild/openbsd-x64/-/openbsd-x64-0.27.2.tgz",
      "integrity": "sha512-/it7w9Nb7+0KFIzjalNJVR5bOzA9Vay+yIPLVHfIQYG/j+j9VTH84aNB8ExGKPU4AzfaEvN9/V4HV+F+vo8OEg==",
      "cpu": [
    ...
    "node_modules/netlify-cli/node_modules/@netlify/zip-it-and-ship-it/node_modules/@esbuild/openharmony-arm64": {
      "version": "0.27.2",
      "resolved": "https://registry.npmjs.org/@esbuild/openharmony-arm64/-/openharmony-arm64-0.27.2.tgz",
      "integrity": "sha512-LRBbCmiU51IXfeXk59csuX/aSaToeG7w48nMwA6049Y4J4+VbWALAuXcs+qcD04rHDuSCSRKdmY63sruDS5qag==",
      "cpu": [
    ...
    "node_modules/netlify-cli/node_modules/@netlify/zip-it-and-ship-it/node_modules/@esbuild/sunos-x64": {
      "version": "0.27.2",
      "resolved": "https://registry.npmjs.org/@esbuild/sunos-x64/-/sunos-x64-0.27.2.tgz",
      "integrity": "sha512-kMtx1yqJHTmqaqHPAzKCAkDaKsffmXkPHThSfRwZGyuqyIeBvf08KSsYXl+abf5HDAPMJIPnbBfXvP2ZC2TfHg==",
      "cpu": [
    ...
    "node_modules/netlify-cli/node_modules/@netlify/zip-it-and-ship-it/node_modules/@esbuild/win32-arm64": {
      "version": "0.27.2",
      "resolved": "https://registry.npmjs.org/@esbuild/win32-arm64/-/win32-arm64-0.27.2.tgz",
      "integrity": "sha512-Yaf78O/B3Kkh+nKABUF++bvJv5Ijoy9AN1ww904rOXZFLWVc5OLOfL56W+C8F9xn5JQZa3UX6m+IktJnIb1Jjg==",
      "cpu": [
    ...
    "node_modules/netlify-cli/node_modules/@netlify/zip-it-and-ship-it/node_modules/@esbuild/win32-ia32": {
      "version": "0.27.2",
      "resolved": "https://registry.npmjs.org/@esbuild/win32-ia32/-/win32-ia32-0.27.2.tgz",
      "integrity": "sha512-Iuws0kxo4yusk7sw70Xa2E2imZU5HoixzxfGCdxwBdhiDgt9vX9VUCBhqcwY7/uh//78A1hMkkROMJq9l27oLQ==",
      "cpu": [
    ...
    "node_modules/netlify-cli/node_modules/@netlify/zip-it-and-ship-it/node_modules/@esbuild/win32-x64": {
      "version": "0.27.2",
      "resolved": "https://registry.npmjs.org/@esbuild/win32-x64/-/win32-x64-0.27.2.tgz",
      "integrity": "sha512-sRdU18mcKf7F+YgheI/zGf5alZatMUTKj/jNS6l744f9u3WFu4v7twcUI9vu4mknF4Y9aDlblIie0IM+5xxaqQ==",
      "cpu": [
    ...
    "node_modules/netlify-cli/node_modules/@netlify/zip-it-and-ship-it/node_modules/get-stream": {
      "version": "8.0.1",
      "resolved": "https://registry.npmjs.org/get-stream/-/get-stream-8.0.1.tgz",
      "integrity": "sha512-VaUJspBffn/LMCJVoMvSAdmscJyS1auj5Zulnn5UoYcY531UWmdwhRWkcGKnGU93m5HSXP9LP2usOryrBtQowA==",
      "dev": true,
    ...
    "node_modules/netlify-cli/node_modules/@netlify/zip-it-and-ship-it/node_modules/signal-exit": {
      "version": "4.1.0",
      "resolved": "https://registry.npmjs.org/signal-exit/-/signal-exit-4.1.0.tgz",
      "integrity": "sha512-bzyZ1e88w9O1iNJbKnOlvYTrWPDl46O1bG0D3XInv+9tkPrxrN8jUUTiFlDkkmKWgn1M6CfIA13SuGqOa9Korw==",
      "dev": true,
    ...
    "node_modules/netlify-cli/node_modules/@opentelemetry/api-logs": {
      "version": "0.203.0",
    ...
    "node_modules/netlify-cli/node_modules/@opentelemetry/context-async-hooks": {
      "version": "1.30.1",
    ...
    "node_modules/netlify-cli/node_modules/@opentelemetry/core": {
      "version": "1.30.1",
    ...
    "node_modules/netlify-cli/node_modules/@opentelemetry/instrumentation": {
      "version": "0.203.0",
    ...
    "node_modules/netlify-cli/node_modules/@opentelemetry/propagator-b3": {
      "version": "1.30.1",
    ...
    "node_modules/netlify-cli/node_modules/@opentelemetry/propagator-jaeger": {
      "version": "1.30.1",
    ...
    "node_modules/netlify-cli/node_modules/@opentelemetry/resources": {
      "version": "1.30.1",
    ...
    "node_modules/netlify-cli/node_modules/@opentelemetry/sdk-trace-base": {
      "version": "1.30.1",
    ...
    "node_modules/netlify-cli/node_modules/@opentelemetry/sdk-trace-node": {
      "version": "1.30.1",
    ...
    "node_modules/netlify-cli/node_modules/@opentelemetry/semantic-conventions": {
      "version": "1.28.0",
    ...
    "node_modules/netlify-cli/node_modules/@parcel/watcher-linux-arm-musl": {
      "version": "2.5.1",
    ...
    "node_modules/netlify-cli/node_modules/@pinojs/redact": {
      "version": "0.4.0",
    ...
    "node_modules/netlify-cli/node_modules/@pnpm/network.ca-file/node_modules/graceful-fs": {
      "version": "4.2.10",
    ...
    "node_modules/netlify-cli/node_modules/@pnpm/tabtab": {
      "version": "0.5.4",
    ...
    "node_modules/netlify-cli/node_modules/@sindresorhus/merge-streams": {
      "version": "2.3.0",
    ...
    "node_modules/netlify-cli/node_modules/@types/triple-beam": {
      "version": "1.3.5",
    ...
    "node_modules/netlify-cli/node_modules/@typescript-eslint/project-service": {
      "version": "8.45.0",
    ...
    "node_modules/netlify-cli/node_modules/@typescript-eslint/tsconfig-utils": {
      "version": "8.45.0",
    ...
    "node_modules/netlify-cli/node_modules/@vue/compiler-core": {
      "version": "3.5.22",
    ...
    "node_modules/netlify-cli/node_modules/@vue/compiler-core/node_modules/entities": {
      "version": "4.5.0",
    ...
    "node_modules/netlify-cli/node_modules/@vue/compiler-dom": {
      "version": "3.5.22",
    ...
    "node_modules/netlify-cli/node_modules/@vue/compiler-sfc": {
      "version": "3.5.22",
    ...
    "node_modules/netlify-cli/node_modules/@vue/compiler-ssr": {
      "version": "3.5.22",
    ...
    "node_modules/netlify-cli/node_modules/@vue/shared": {
      "version": "3.5.22",
    ...
    "node_modules/netlify-cli/node_modules/@whatwg-node/fetch": {
      "version": "0.10.11",
    ...
    "node_modules/netlify-cli/node_modules/@whatwg-node/fetch/node_modules/urlpattern-polyfill": {
      "version": "10.1.0",
      "resolved": "https://registry.npmjs.org/urlpattern-polyfill/-/urlpattern-polyfill-10.1.0.tgz",
      "integrity": "sha512-IGjKp/o0NL3Bso1PymYURCJxMPNAf/ILOpendP9f5B6e1rTJgdgiOvgfoT8VxCAdY+Wisb9uhGaJJf3yZ2V9nw==",
      "dev": true
    },
    "node_modules/netlify-cli/node_modules/@whatwg-node/node-fetch": {
      "version": "0.8.0",
    ...
    "node_modules/netlify-cli/node_modules/@whatwg-node/promise-helpers": {
      "version": "1.3.2",
    ...
    "node_modules/netlify-cli/node_modules/@whatwg-node/server": {
      "version": "0.10.12",
    ...
    "node_modules/netlify-cli/node_modules/@xhmikosr/decompress-unzip/node_modules/get-stream": {
      "version": "6.0.1",
    ...
    "node_modules/netlify-cli/node_modules/@xhmikosr/downloader/node_modules/get-stream": {
      "version": "6.0.1",
      "resolved": "https://registry.npmjs.org/get-stream/-/get-stream-6.0.1.tgz",
      "integrity": "sha512-ts6Wi+2j3jQjqi70w5AlN8DFnkSwC+MqmxEzdEALB2qXZYV3X/b1CTfgPLGJNMeAWxdPfU8FO1ms3NUfaHCPYg==",
      "dev": true,
    ...
    "node_modules/netlify-cli/node_modules/@xhmikosr/downloader/node_modules/p-event": {
      "version": "5.0.1",
    ...
    "node_modules/netlify-cli/node_modules/@xhmikosr/downloader/node_modules/p-timeout": {
      "version": "5.1.0",
    ...
    "node_modules/netlify-cli/node_modules/ajv-errors": {
      "version": "3.0.0",
    ...
    "node_modules/netlify-cli/node_modules/ansi-align/node_modules/ansi-regex": {
      "version": "5.0.1",
    ...
    "node_modules/netlify-cli/node_modules/ansi-align/node_modules/emoji-regex": {
      "version": "8.0.0",
      "resolved": "https://registry.npmjs.org/emoji-regex/-/emoji-regex-8.0.0.tgz",
      "integrity": "sha512-MSjYzcWNOA0ewAHpz0MxpYFvwg6yjy1NG3xteoqz644VCo/RPgnr1/GGt+ic3iJTzQ8Eu3TdM14SawnVUmGE6A==",
      "dev": true
    },
    "node_modules/netlify-cli/node_modules/ansi-align/node_modules/is-fullwidth-code-point": {
      "version": "3.0.0",
    ...
    "node_modules/netlify-cli/node_modules/ansi-align/node_modules/string-width": {
      "version": "4.2.3",
    ...
    "node_modules/netlify-cli/node_modules/ansi-align/node_modules/strip-ansi": {
      "version": "6.0.1",
    ...
    "node_modules/netlify-cli/node_modules/ansi-colors": {
      "version": "4.1.3",
    ...
    "node_modules/netlify-cli/node_modules/ansis": {
      "version": "4.1.0",
    ...
    "node_modules/netlify-cli/node_modules/anymatch/node_modules/picomatch": {
      "version": "2.3.1",
    ...
    "node_modules/netlify-cli/node_modules/bare-events": {
      "version": "2.7.0",
    ...
    "node_modules/netlify-cli/node_modules/bl/node_modules/readable-stream": {
      "version": "3.6.2",
    ...
    "node_modules/netlify-cli/node_modules/call-bind-apply-helpers": {
      "version": "1.0.2",
    ...
    "node_modules/netlify-cli/node_modules/call-bound": {
      "version": "1.0.4",
    ...
    "node_modules/netlify-cli/node_modules/cjs-module-lexer": {
      "version": "1.4.3",
    ...
    "node_modules/netlify-cli/node_modules/cliui": {
      "version": "8.0.1",
    ...
    "node_modules/netlify-cli/node_modules/cliui/node_modules/ansi-regex": {
      "version": "5.0.1",
      "resolved": "https://registry.npmjs.org/ansi-regex/-/ansi-regex-5.0.1.tgz",
      "integrity": "sha512-quJQXlTSUGL2LH9SUXo8VwsY4soanhgo6LNSm84E1LBcE8s3O0wpdiRzyR9z/ZZJMlMWv37qOOb9pdJlMUEKFQ==",
      "dev": true,
    ...
    "node_modules/netlify-cli/node_modules/cliui/node_modules/ansi-styles": {
      "version": "4.3.0",
      "resolved": "https://registry.npmjs.org/ansi-styles/-/ansi-styles-4.3.0.tgz",
      "integrity": "sha512-zbB9rCJAT1rbjiVDb2hqKFHNYLxgtk8NURxZ3IZwD3F6NtxbXZQCnnSi1Lkx+IDohdPlFp222wVALIheZJQSEg==",
      "dev": true,
    ...
    "node_modules/netlify-cli/node_modules/cliui/node_modules/color-convert": {
      "version": "2.0.1",
      "resolved": "https://registry.npmjs.org/color-convert/-/color-convert-2.0.1.tgz",
      "integrity": "sha512-RRECPsj7iu/xb5oKYcsFHSppFNnsj/52OVTRKb4zP5onXwVF3zVmmToNcOfGC+CRDpfK/U584fMg38ZHCaElKQ==",
      "dev": true,
    ...
    "node_modules/netlify-cli/node_modules/cliui/node_modules/emoji-regex": {
      "version": "8.0.0",
      "resolved": "https://registry.npmjs.org/emoji-regex/-/emoji-regex-8.0.0.tgz",
      "integrity": "sha512-MSjYzcWNOA0ewAHpz0MxpYFvwg6yjy1NG3xteoqz644VCo/RPgnr1/GGt+ic3iJTzQ8Eu3TdM14SawnVUmGE6A==",
      "dev": true
    },
    "node_modules/netlify-cli/node_modules/cliui/node_modules/is-fullwidth-code-point": {
      "version": "3.0.0",
      "resolved": "https://registry.npmjs.org/is-fullwidth-code-point/-/is-fullwidth-code-point-3.0.0.tgz",
      "integrity": "sha512-zymm5+u+sCsSWyD9qNaejV3DFvhCKclKdizYaJUuHA83RLjb7nSuGnddCHGv0hk+KY7BMAlsWeK4Ueg6EV6XQg==",
      "dev": true,
    ...
    "node_modules/netlify-cli/node_modules/cliui/node_modules/string-width": {
      "version": "4.2.3",
      "resolved": "https://registry.npmjs.org/string-width/-/string-width-4.2.3.tgz",
      "integrity": "sha512-wKyQRQpjJ0sIp62ErSZdGsjMJWsap5oRNihHhu6G7JVO/9jIB6UyevL+tXuOqrng8j/cxKTWyWUwvSTriiZz/g==",
      "dev": true,
    ...
    "node_modules/netlify-cli/node_modules/cliui/node_modules/strip-ansi": {
      "version": "6.0.1",
      "resolved": "https://registry.npmjs.org/strip-ansi/-/strip-ansi-6.0.1.tgz",
      "integrity": "sha512-Y38VPSHcqkFrCpFnQ9vuSXmquuv5oXOKpGeT6aGrr3o3Gc9AlVa6JBfUSOCnbxGGZF+/0ooI7KrPuUSztUdU5A==",
      "dev": true,
    ...
    "node_modules/netlify-cli/node_modules/cliui/node_modules/wrap-ansi": {
      "version": "7.0.0",
    ...
    "node_modules/netlify-cli/node_modules/clone": {
      "version": "1.0.4",
    ...
    "node_modules/netlify-cli/node_modules/color-convert/node_modules/color-name": {
      "version": "1.1.3",
    ...
    "node_modules/netlify-cli/node_modules/confbox": {
      "version": "0.1.8",
    ...
    "node_modules/netlify-cli/node_modules/copy-file": {
      "version": "11.1.0",
    ...
    "node_modules/netlify-cli/node_modules/default-browser": {
      "version": "5.5.0",
    ...
    "node_modules/netlify-cli/node_modules/default-browser-id": {
      "version": "5.0.0",
    ...
    "node_modules/netlify-cli/node_modules/defaults": {
      "version": "1.0.4",
    ...
    "node_modules/netlify-cli/node_modules/dequal": {
      "version": "2.0.3",
    ...
    "node_modules/netlify-cli/node_modules/detective-vue2": {
      "version": "2.2.0",
    ...
    "node_modules/netlify-cli/node_modules/dom-serializer/node_modules/entities": {
      "version": "4.5.0",
      "resolved": "https://registry.npmjs.org/entities/-/entities-4.5.0.tgz",
      "integrity": "sha512-V0hjH4dGPh9Ao5p0MoRY6BVqtwCjhz6vI5LT8AJ55H+4g9/4vbHx1I54fS0XuclLhDHArPQCiMjDxjaL8fPxhw==",
      "dev": true,
    ...
    "node_modules/netlify-cli/node_modules/dunder-proto": {
      "version": "1.0.1",
    ...
    "node_modules/netlify-cli/node_modules/enquirer": {
      "version": "2.4.1",
    ...
    "node_modules/netlify-cli/node_modules/enquirer/node_modules/ansi-regex": {
      "version": "5.0.1",
      "resolved": "https://registry.npmjs.org/ansi-regex/-/ansi-regex-5.0.1.tgz",
      "integrity": "sha512-quJQXlTSUGL2LH9SUXo8VwsY4soanhgo6LNSm84E1LBcE8s3O0wpdiRzyR9z/ZZJMlMWv37qOOb9pdJlMUEKFQ==",
      "dev": true,
    ...
    "node_modules/netlify-cli/node_modules/enquirer/node_modules/strip-ansi": {
      "version": "6.0.1",
      "resolved": "https://registry.npmjs.org/strip-ansi/-/strip-ansi-6.0.1.tgz",
      "integrity": "sha512-Y38VPSHcqkFrCpFnQ9vuSXmquuv5oXOKpGeT6aGrr3o3Gc9AlVa6JBfUSOCnbxGGZF+/0ooI7KrPuUSztUdU5A==",
      "dev": true,
    ...
    "node_modules/netlify-cli/node_modules/es-object-atoms": {
      "version": "1.1.1",
    ...
    "node_modules/netlify-cli/node_modules/escape-string-regexp": {
      "version": "5.0.0",
    ...
    "node_modules/netlify-cli/node_modules/events-universal": {
      "version": "1.0.1",
    ...
    "node_modules/netlify-cli/node_modules/execa/node_modules/get-stream": {
      "version": "6.0.1",
      "resolved": "https://registry.npmjs.org/get-stream/-/get-stream-6.0.1.tgz",
      "integrity": "sha512-ts6Wi+2j3jQjqi70w5AlN8DFnkSwC+MqmxEzdEALB2qXZYV3X/b1CTfgPLGJNMeAWxdPfU8FO1ms3NUfaHCPYg==",
      "dev": true,
    ...
    "node_modules/netlify-cli/node_modules/express/node_modules/accepts": {
      "version": "2.0.0",
    ...
    "node_modules/netlify-cli/node_modules/express/node_modules/body-parser": {
      "version": "2.2.2",
    ...
    "node_modules/netlify-cli/node_modules/express/node_modules/content-disposition": {
      "version": "1.0.1",
      "resolved": "https://registry.npmjs.org/content-disposition/-/content-disposition-1.0.1.tgz",
      "integrity": "sha512-oIXISMynqSqm241k6kcQ5UwttDILMK4BiurCfGEREw6+X9jkkpEe5T9FZaApyLGGOnFuyMWZpdolTXMtvEJ08Q==",
      "dev": true,
    ...
    "node_modules/netlify-cli/node_modules/express/node_modules/cookie-signature": {
      "version": "1.2.2",
    ...
    "node_modules/netlify-cli/node_modules/express/node_modules/fresh": {
      "version": "2.0.0",
    ...
    "node_modules/netlify-cli/node_modules/express/node_modules/iconv-lite": {
      "version": "0.7.2",
      "resolved": "https://registry.npmjs.org/iconv-lite/-/iconv-lite-0.7.2.tgz",
      "integrity": "sha512-im9DjEDQ55s9fL4EYzOAv0yMqmMBSZp6G0VvFyTMPKWxiSBHUj9NW/qqLmXUwXrrM7AvqSlTCfvqRb0cM8yYqw==",
      "dev": true,
    ...
    "node_modules/netlify-cli/node_modules/express/node_modules/media-typer": {
      "version": "1.1.0",
    ...
    "node_modules/netlify-cli/node_modules/express/node_modules/merge-descriptors": {
      "version": "2.0.0",
    ...
    "node_modules/netlify-cli/node_modules/express/node_modules/mime-db": {
      "version": "1.54.0",
    ...
    "node_modules/netlify-cli/node_modules/express/node_modules/mime-types": {
      "version": "3.0.2",
    ...
    "node_modules/netlify-cli/node_modules/express/node_modules/negotiator": {
      "version": "1.0.0",
    ...
    "node_modules/netlify-cli/node_modules/express/node_modules/send": {
      "version": "1.2.1",
    ...
    "node_modules/netlify-cli/node_modules/express/node_modules/statuses": {
      "version": "2.0.2",
    ...
    "node_modules/netlify-cli/node_modules/express/node_modules/type-is": {
      "version": "2.0.1",
    ...
    "node_modules/netlify-cli/node_modules/fast-glob/node_modules/glob-parent": {
      "version": "5.1.2",
    ...
    "node_modules/netlify-cli/node_modules/fast-stringify": {
      "version": "4.0.0",
      "resolved": "https://registry.npmjs.org/fast-stringify/-/fast-stringify-4.0.0.tgz",
      "integrity": "sha512-lE2DIivBaLysf6hK5WH/VfMgqRbvBVHcpGVVTmA5Zi8oWIjq9YxIt6lYGdUgP1HNSXxTIat7HEIDnrSvXSeKQw==",
      "dev": true,
      "license": "MIT"
    },
    ...
    "node_modules/netlify-cli/node_modules/filename-reserved-regex": {
      "version": "3.0.0",
    ...
    "node_modules/netlify-cli/node_modules/filenamify": {
      "version": "5.1.1",
    ...
    "node_modules/netlify-cli/node_modules/find-up/node_modules/locate-path": {
      "version": "8.0.0",
    ...
    "node_modules/netlify-cli/node_modules/find-up/node_modules/unicorn-magic": {
      "version": "0.3.0",
    ...
    "node_modules/netlify-cli/node_modules/from2/node_modules/safe-buffer": {
      "version": "5.1.2",
      "resolved": "https://registry.npmjs.org/safe-buffer/-/safe-buffer-5.1.2.tgz",
      "integrity": "sha512-Gd2UZBJDkXlY7GbJxfsE8/nvKkUEU1G38c1siN6QP6a9PT9MmHB8GnpscSmMJSoF8LOIrt8ud/wPtojys4G6+g==",
      "dev": true
    },
    "node_modules/netlify-cli/node_modules/from2/node_modules/string_decoder": {
      "version": "1.1.1",
    ...
    "node_modules/netlify-cli/node_modules/get-proto": {
      "version": "1.0.1",
    ...
    "node_modules/netlify-cli/node_modules/globby/node_modules/ignore": {
      "version": "7.0.5",
    ...
    "node_modules/netlify-cli/node_modules/globby/node_modules/unicorn-magic": {
      "version": "0.3.0",
      "resolved": "https://registry.npmjs.org/unicorn-magic/-/unicorn-magic-0.3.0.tgz",
      "integrity": "sha512-+QBBXBCvifc56fsbuxZQ6Sic3wqqc3WWaqxs58gvJrcOuN83HGTCwz3oS5phzU9LthRNE9VrJCFCLUgHeeFnfA==",
      "dev": true,
    ...
    "node_modules/netlify-cli/node_modules/got/node_modules/get-stream": {
      "version": "6.0.1",
      "resolved": "https://registry.npmjs.org/get-stream/-/get-stream-6.0.1.tgz",
      "integrity": "sha512-ts6Wi+2j3jQjqi70w5AlN8DFnkSwC+MqmxEzdEALB2qXZYV3X/b1CTfgPLGJNMeAWxdPfU8FO1ms3NUfaHCPYg==",
      "dev": true,
    ...
    "node_modules/netlify-cli/node_modules/hosted-git-info/node_modules/lru-cache": {
      "version": "10.4.3",
    ...
    "node_modules/netlify-cli/node_modules/hot-shots": {
      "version": "11.4.0",
      "resolved": "https://registry.npmjs.org/hot-shots/-/hot-shots-11.4.0.tgz",
      "integrity": "sha512-IoyXi0eBFLbaARl6IjQxNzxqNxH3h1XX026PP5uru/RwVVLOt9Qr9f87GW+4L/sj7sNyMGzmIsh++0z5ibkP5w==",
      "dev": true,
      "license": "MIT",
      "engines": {
        "node": ">=16.0.0"
    ...
    "node_modules/netlify-cli/node_modules/image-size": {
      "version": "2.0.2",
    ...
    "node_modules/netlify-cli/node_modules/import-in-the-middle": {
      "version": "1.15.0",
    ...
    "node_modules/netlify-cli/node_modules/indent-string": {
      "version": "5.0.0",
    ...
    "node_modules/netlify-cli/node_modules/ini": {
      "version": "1.3.8",
    ...
    "node_modules/netlify-cli/node_modules/inquirer-autocomplete-prompt/node_modules/escape-string-regexp": {
      "version": "1.0.5",
    ...
    "node_modules/netlify-cli/node_modules/inquirer-autocomplete-prompt/node_modules/figures": {
      "version": "3.2.0",
    ...
    "node_modules/netlify-cli/node_modules/inquirer-autocomplete-prompt/node_modules/rxjs": {
      "version": "6.6.7",
    ...
    "node_modules/netlify-cli/node_modules/inquirer-autocomplete-prompt/node_modules/tslib": {
      "version": "1.14.1",
    ...
    "node_modules/netlify-cli/node_modules/inquirer/node_modules/color-convert": {
      "version": "2.0.1",
      "resolved": "https://registry.npmjs.org/color-convert/-/color-convert-2.0.1.tgz",
      "integrity": "sha512-RRECPsj7iu/xb5oKYcsFHSppFNnsj/52OVTRKb4zP5onXwVF3zVmmToNcOfGC+CRDpfK/U584fMg38ZHCaElKQ==",
      "dev": true,
    ...
    "node_modules/netlify-cli/node_modules/inquirer/node_modules/emoji-regex": {
      "version": "8.0.0",
      "resolved": "https://registry.npmjs.org/emoji-regex/-/emoji-regex-8.0.0.tgz",
      "integrity": "sha512-MSjYzcWNOA0ewAHpz0MxpYFvwg6yjy1NG3xteoqz644VCo/RPgnr1/GGt+ic3iJTzQ8Eu3TdM14SawnVUmGE6A==",
      "dev": true
    ...
    "node_modules/netlify-cli/node_modules/inquirer/node_modules/type-fest": {
      "version": "0.21.3",
      "resolved": "https://registry.npmjs.org/type-fest/-/type-fest-0.21.3.tgz",
      "integrity": "sha512-t0rzBq87m3fVcduHDUFhKmyyX+9eo6WQjZvf51Ea/M0Q7+T374Jp1aUiyUl0GKxp8M/OETVHSDvmkyPgvX+X2w==",
      "dev": true,
    ...
    "node_modules/netlify-cli/node_modules/inquirer/node_modules/wrap-ansi": {
      "version": "6.2.0",
    ...
    "node_modules/netlify-cli/node_modules/is-error-instance": {
      "version": "2.0.0",
    ...
    "node_modules/netlify-cli/node_modules/is-in-ssh": {
      "version": "1.0.0",
    ...
    "node_modules/netlify-cli/node_modules/is-network-error": {
      "version": "1.3.0",
    ...
    "node_modules/netlify-cli/node_modules/is-plain-object": {
      "version": "5.0.0",
      "resolved": "https://registry.npmjs.org/is-plain-object/-/is-plain-object-5.0.0.tgz",
      "integrity": "sha512-VRSzKkbMm5jMDoKLbltAkFQ5Qr7VDiTFGXxYFXXowVj387GeGNOCsOH6Msy00SGZ3Fp84b1Naa1psqgcCIEP5Q==",
      "dev": true,
    ...
    "node_modules/netlify-cli/node_modules/is-safe-filename": {
      "version": "0.1.1",
    ...
    "node_modules/netlify-cli/node_modules/jpeg-js": {
      "version": "0.4.4",
      "resolved": "https://registry.npmjs.org/jpeg-js/-/jpeg-js-0.4.4.tgz",
      "integrity": "sha512-WZzeDOEtTOBK4Mdsar0IqEU5sMr3vSV2RqkAIzUEV2BHnUfKGyswWFPFwK5EeDo93K3FohSHbLAjj0s1Wzd+dg==",
      "dev": true
    },
    "node_modules/netlify-cli/node_modules/js-image-generator": {
      "version": "1.0.4",
    ...
    "node_modules/netlify-cli/node_modules/jsonwebtoken/node_modules/jwa": {
      "version": "2.0.1",
    ...
    "node_modules/netlify-cli/node_modules/jsonwebtoken/node_modules/jws": {
      "version": "4.0.1",
    ...
    "node_modules/netlify-cli/node_modules/keep-func-props": {
      "version": "6.0.0",
      "resolved": "https://registry.npmjs.org/keep-func-props/-/keep-func-props-6.0.0.tgz",
      "integrity": "sha512-XDYA44ccm6W2MXZeQcDZykS5srkTpPf6Z59AEuOFbfuqdQ5TVxhAjxgzAEFBpr8XpsCEgr/XeCBFAmc9x6wRmQ==",
      "dev": true,
      "dependencies": {
        "mimic-fn": "^4.0.0"
      },
    ...
    "node_modules/netlify-cli/node_modules/lambda-local/node_modules/commander": {
      "version": "10.0.1",
    ...
    "node_modules/netlify-cli/node_modules/lazystream/node_modules/safe-buffer": {
      "version": "5.1.2",
      "resolved": "https://registry.npmjs.org/safe-buffer/-/safe-buffer-5.1.2.tgz",
      "integrity": "sha512-Gd2UZBJDkXlY7GbJxfsE8/nvKkUEU1G38c1siN6QP6a9PT9MmHB8GnpscSmMJSoF8LOIrt8ud/wPtojys4G6+g==",
      "dev": true
    },
    "node_modules/netlify-cli/node_modules/lazystream/node_modules/string_decoder": {
      "version": "1.1.1",
      "resolved": "https://registry.npmjs.org/string_decoder/-/string_decoder-1.1.1.tgz",
      "integrity": "sha512-n/ShnvDi6FHbbVfviro+WojiFzv+s8MPMHBczVePfUpDJLwoLT0ht1l4YwBCbi8pJAveEEdnkHyPyTP/mzRfwg==",
      "dev": true,
    ...
    "node_modules/netlify-cli/node_modules/listhen/node_modules/pathe": {
      "version": "1.1.2",
    ...
    "node_modules/netlify-cli/node_modules/log-process-errors": {
      "version": "11.0.1",
      "resolved": "https://registry.npmjs.org/log-process-errors/-/log-process-errors-11.0.1.tgz",
      "integrity": "sha512-HXYU83z3kH0VHfJgGyv9ZP9z7uNEayssgvpeQwSzh60mvpNqUBCPyXLSzCDSMxfGvAUUa0Kw06wJjVR46Ohd3A==",
      "dev": true,
      "dependencies": {
    ...
    "node_modules/netlify-cli/node_modules/log-symbols/node_modules/ansi-styles": {
      "version": "4.3.0",
      "resolved": "https://registry.npmjs.org/ansi-styles/-/ansi-styles-4.3.0.tgz",
      "integrity": "sha512-zbB9rCJAT1rbjiVDb2hqKFHNYLxgtk8NURxZ3IZwD3F6NtxbXZQCnnSi1Lkx+IDohdPlFp222wVALIheZJQSEg==",
      "dev": true,
    ...
    "node_modules/netlify-cli/node_modules/log-symbols/node_modules/chalk": {
      "version": "4.1.2",
      "resolved": "https://registry.npmjs.org/chalk/-/chalk-4.1.2.tgz",
      "integrity": "sha512-oKnbhFyRIXpUuez8iBMmyEa4nbj4IOQyuhc/wy9kY7/WVPcwIO9VA668Pu8RkO7+0G76SLROeyw9CpQ061i4mA==",
      "dev": true,
    ...
    "node_modules/netlify-cli/node_modules/log-symbols/node_modules/color-convert": {
      "version": "2.0.1",
      "resolved": "https://registry.npmjs.org/color-convert/-/color-convert-2.0.1.tgz",
      "integrity": "sha512-RRECPsj7iu/xb5oKYcsFHSppFNnsj/52OVTRKb4zP5onXwVF3zVmmToNcOfGC+CRDpfK/U584fMg38ZHCaElKQ==",
      "dev": true,
    ...
    "node_modules/netlify-cli/node_modules/log-symbols/node_modules/is-unicode-supported": {
      "version": "0.1.0",
    ...
    "node_modules/netlify-cli/node_modules/log-symbols/node_modules/supports-color": {
      "version": "7.2.0",
      "resolved": "https://registry.npmjs.org/supports-color/-/supports-color-7.2.0.tgz",
      "integrity": "sha512-qpCAvRl9stuOHveKsn7HncJRvv501qIacKzQlO/+Lwxc9+0q2wLyv4Dfvt80/DPn2pqOBsJdDiogXGR9+OvwRw==",
      "dev": true,
    ...
    "node_modules/netlify-cli/node_modules/map-obj": {
      "version": "5.0.2",
    ...
    "node_modules/netlify-cli/node_modules/math-intrinsics": {
      "version": "1.1.0",
    ...
    "node_modules/netlify-cli/node_modules/micro-memoize": {
      "version": "5.1.1",
      "resolved": "https://registry.npmjs.org/micro-memoize/-/micro-memoize-5.1.1.tgz",
      "integrity": "sha512-QDwluos8YeMijiKxZGwaV4f4tzj0soS6+xcsJhJ3+4wdEIHMyKbIKVUziebOgWX3e6yiijdoaHo+9tyhbnaWXA==",
      "dev": true,
      "license": "MIT",
      "dependencies": {
        "fast-equals": "^5.3.3",
    ...
    "node_modules/netlify-cli/node_modules/micromatch/node_modules/picomatch": {
      "version": "2.3.1",
      "resolved": "https://registry.npmjs.org/picomatch/-/picomatch-2.3.1.tgz",
      "integrity": "sha512-JU3teHTNjmE2VCGFzuY8EXzCDVwEqB2a8fsIvwaStHhAWJEeVd1o1QD80CU6+ZdEXXSLbSsuLwJjkCBWqRQUVA==",
      "dev": true,
    ...
    "node_modules/netlify-cli/node_modules/module-details-from-path": {
      "version": "1.0.4",
    ...
    "node_modules/netlify-cli/node_modules/multiparty/node_modules/depd": {
      "version": "1.1.2",
    ...
    "node_modules/netlify-cli/node_modules/multiparty/node_modules/http-errors": {
      "version": "1.8.1",
    ...
    "node_modules/netlify-cli/node_modules/multiparty/node_modules/statuses": {
      "version": "1.5.0",
    ...
    "node_modules/netlify-cli/node_modules/normalize-exception": {
      "version": "3.0.0",
      "resolved": "https://registry.npmjs.org/normalize-exception/-/normalize-exception-3.0.0.tgz",
      "integrity": "sha512-SMZtWSLjls45KBgwvS2jWyXLtOI9j90JyQ6tJstl91Gti4W7QwZyF/nWwlFRz/Cx4Gy70DAtLT0EzXYXcPJJUw==",
      "dev": true,
      "dependencies": {
        "is-error-instance": "^2.0.0",
        "is-plain-obj": "^4.1.0"
    ...
    "node_modules/netlify-cli/node_modules/ora/node_modules/ansi-regex": {
      "version": "5.0.1",
      "resolved": "https://registry.npmjs.org/ansi-regex/-/ansi-regex-5.0.1.tgz",
      "integrity": "sha512-quJQXlTSUGL2LH9SUXo8VwsY4soanhgo6LNSm84E1LBcE8s3O0wpdiRzyR9z/ZZJMlMWv37qOOb9pdJlMUEKFQ==",
      "dev": true,
    ...
    "node_modules/netlify-cli/node_modules/ora/node_modules/ansi-styles": {
      "version": "4.3.0",
      "resolved": "https://registry.npmjs.org/ansi-styles/-/ansi-styles-4.3.0.tgz",
      "integrity": "sha512-zbB9rCJAT1rbjiVDb2hqKFHNYLxgtk8NURxZ3IZwD3F6NtxbXZQCnnSi1Lkx+IDohdPlFp222wVALIheZJQSEg==",
      "dev": true,
    ...
    "node_modules/netlify-cli/node_modules/ora/node_modules/chalk": {
      "version": "4.1.2",
      "resolved": "https://registry.npmjs.org/chalk/-/chalk-4.1.2.tgz",
      "integrity": "sha512-oKnbhFyRIXpUuez8iBMmyEa4nbj4IOQyuhc/wy9kY7/WVPcwIO9VA668Pu8RkO7+0G76SLROeyw9CpQ061i4mA==",
      "dev": true,
    ...
    "node_modules/netlify-cli/node_modules/ora/node_modules/color-convert": {
      "version": "2.0.1",
      "resolved": "https://registry.npmjs.org/color-convert/-/color-convert-2.0.1.tgz",
      "integrity": "sha512-RRECPsj7iu/xb5oKYcsFHSppFNnsj/52OVTRKb4zP5onXwVF3zVmmToNcOfGC+CRDpfK/U584fMg38ZHCaElKQ==",
      "dev": true,
    ...
    "node_modules/netlify-cli/node_modules/ora/node_modules/strip-ansi": {
      "version": "6.0.1",
      "resolved": "https://registry.npmjs.org/strip-ansi/-/strip-ansi-6.0.1.tgz",
      "integrity": "sha512-Y38VPSHcqkFrCpFnQ9vuSXmquuv5oXOKpGeT6aGrr3o3Gc9AlVa6JBfUSOCnbxGGZF+/0ooI7KrPuUSztUdU5A==",
      "dev": true,
    ...
    "node_modules/netlify-cli/node_modules/ora/node_modules/supports-color": {
      "version": "7.2.0",
      "resolved": "https://registry.npmjs.org/supports-color/-/supports-color-7.2.0.tgz",
      "integrity": "sha512-qpCAvRl9stuOHveKsn7HncJRvv501qIacKzQlO/+Lwxc9+0q2wLyv4Dfvt80/DPn2pqOBsJdDiogXGR9+OvwRw==",
      "dev": true,
    ...
    "node_modules/netlify-cli/node_modules/p-limit": {
      "version": "4.0.0",
    ...
    "node_modules/netlify-cli/node_modules/p-locate": {
      "version": "6.0.0",
    ...
    "node_modules/netlify-cli/node_modules/p-wait-for": {
      "version": "6.0.0",
      "resolved": "https://registry.npmjs.org/p-wait-for/-/p-wait-for-6.0.0.tgz",
    ...
    "node_modules/netlify-cli/node_modules/package-directory": {
      "version": "8.1.0",
    ...
    "node_modules/netlify-cli/node_modules/package-json-from-dist": {
      "version": "1.0.1",
    ...
    "node_modules/netlify-cli/node_modules/parallel-transform/node_modules/safe-buffer": {
      "version": "5.1.2",
      "resolved": "https://registry.npmjs.org/safe-buffer/-/safe-buffer-5.1.2.tgz",
      "integrity": "sha512-Gd2UZBJDkXlY7GbJxfsE8/nvKkUEU1G38c1siN6QP6a9PT9MmHB8GnpscSmMJSoF8LOIrt8ud/wPtojys4G6+g==",
      "dev": true
    },
    "node_modules/netlify-cli/node_modules/parallel-transform/node_modules/string_decoder": {
      "version": "1.1.1",
      "resolved": "https://registry.npmjs.org/string_decoder/-/string_decoder-1.1.1.tgz",
      "integrity": "sha512-n/ShnvDi6FHbbVfviro+WojiFzv+s8MPMHBczVePfUpDJLwoLT0ht1l4YwBCbi8pJAveEEdnkHyPyTP/mzRfwg==",
      "dev": true,
    ...
    "node_modules/netlify-cli/node_modules/parse-imports": {
      "version": "2.2.1",
    ...
    "node_modules/netlify-cli/node_modules/path-exists": {
      "version": "5.0.0",
    ...
    "node_modules/netlify-cli/node_modules/powershell-utils": {
      "version": "0.1.0",
    ...
    "node_modules/netlify-cli/node_modules/process-warning": {
      "version": "5.0.0",
    ...
    "node_modules/netlify-cli/node_modules/read-package-up/node_modules/unicorn-magic": {
      "version": "0.3.0",
      "resolved": "https://registry.npmjs.org/unicorn-magic/-/unicorn-magic-0.3.0.tgz",
      "integrity": "sha512-+QBBXBCvifc56fsbuxZQ6Sic3wqqc3WWaqxs58gvJrcOuN83HGTCwz3oS5phzU9LthRNE9VrJCFCLUgHeeFnfA==",
      "dev": true,
    ...
    "node_modules/netlify-cli/node_modules/read-pkg": {
      "version": "9.0.1",
    ...
    "node_modules/netlify-cli/node_modules/read-pkg/node_modules/hosted-git-info": {
      "version": "7.0.2",
    ...
    "node_modules/netlify-cli/node_modules/read-pkg/node_modules/lru-cache": {
      "version": "10.4.3",
      "resolved": "https://registry.npmjs.org/lru-cache/-/lru-cache-10.4.3.tgz",
      "integrity": "sha512-JNAzZcXrCt42VGLuYz0zfAzDfAvJWW6AfYlDBQyDV5DClI2m5sAmK+OIO7s59XfsRsWHp02jAJrRadPRGTt6SQ==",
      "dev": true
    },
    "node_modules/netlify-cli/node_modules/read-pkg/node_modules/normalize-package-data": {
      "version": "6.0.2",
    ...
    "node_modules/netlify-cli/node_modules/readable-stream/node_modules/buffer": {
      "version": "6.0.3",
    ...
    "node_modules/netlify-cli/node_modules/require-in-the-middle": {
      "version": "7.5.2",
    ...
    "node_modules/netlify-cli/node_modules/require-in-the-middle/node_modules/resolve": {
      "version": "1.22.11",
    ...
    "node_modules/netlify-cli/node_modules/ret": {
      "version": "0.5.0",
    ...
    "node_modules/netlify-cli/node_modules/router/node_modules/is-promise": {
      "version": "4.0.0",
    ...
    "node_modules/netlify-cli/node_modules/router/node_modules/path-to-regexp": {
      "version": "8.3.0",
    ...
    "node_modules/netlify-cli/node_modules/sax": {
      "version": "1.4.1",
    ...
    "node_modules/netlify-cli/node_modules/set-error-message": {
      "version": "2.0.1",
      "resolved": "https://registry.npmjs.org/set-error-message/-/set-error-message-2.0.1.tgz",
    ...
    "node_modules/netlify-cli/node_modules/side-channel-list": {
      "version": "1.0.0",
    ...
    "node_modules/netlify-cli/node_modules/side-channel-map": {
      "version": "1.0.1",
    ...
    "node_modules/netlify-cli/node_modules/side-channel-weakmap": {
      "version": "1.0.2",
    ...
    "node_modules/netlify-cli/node_modules/slashes": {
      "version": "3.0.12",
    ...
    "node_modules/netlify-cli/node_modules/sonic-boom": {
      "version": "4.2.0",
    ...
    "node_modules/netlify-cli/node_modules/split2": {
      "version": "1.1.1",
    ...
    "node_modules/netlify-cli/node_modules/string-width-cjs/node_modules/ansi-regex": {
      "version": "5.0.1",
      "resolved": "https://registry.npmjs.org/ansi-regex/-/ansi-regex-5.0.1.tgz",
      "integrity": "sha512-quJQXlTSUGL2LH9SUXo8VwsY4soanhgo6LNSm84E1LBcE8s3O0wpdiRzyR9z/ZZJMlMWv37qOOb9pdJlMUEKFQ==",
      "dev": true,
    ...
    "node_modules/netlify-cli/node_modules/string-width-cjs/node_modules/emoji-regex": {
      "version": "8.0.0",
      "resolved": "https://registry.npmjs.org/emoji-regex/-/emoji-regex-8.0.0.tgz",
      "integrity": "sha512-MSjYzcWNOA0ewAHpz0MxpYFvwg6yjy1NG3xteoqz644VCo/RPgnr1/GGt+ic3iJTzQ8Eu3TdM14SawnVUmGE6A==",
      "dev": true
    ...
    "node_modules/netlify-cli/node_modules/strip-ansi-cjs/node_modules/ansi-regex": {
      "version": "5.0.1",
      "resolved": "https://registry.npmjs.org/ansi-regex/-/ansi-regex-5.0.1.tgz",
      "integrity": "sha512-quJQXlTSUGL2LH9SUXo8VwsY4soanhgo6LNSm84E1LBcE8s3O0wpdiRzyR9z/ZZJMlMWv37qOOb9pdJlMUEKFQ==",
      "dev": true,
    ...
    "node_modules/netlify-cli/node_modules/strip-outer": {
      "version": "2.0.0",
    ...
    "node_modules/netlify-cli/node_modules/tagged-tag": {
      "version": "1.0.0",
    ...
    "node_modules/netlify-cli/node_modules/tar/node_modules/yallist": {
      "version": "5.0.0",
    ...
    "node_modules/netlify-cli/node_modules/terminal-link/node_modules/has-flag": {
      "version": "5.0.1",
    ...
    "node_modules/netlify-cli/node_modules/terminal-link/node_modules/supports-hyperlinks": {
      "version": "4.4.0",
    ...
    "node_modules/netlify-cli/node_modules/text-decoder": {
      "version": "1.2.3",
    ...
    "node_modules/netlify-cli/node_modules/through2/node_modules/readable-stream": {
      "version": "2.3.8",
      "resolved": "https://registry.npmjs.org/readable-stream/-/readable-stream-2.3.8.tgz",
      "integrity": "sha512-8p0AUk4XODgIewSi0l8Epjs+EVnWiK7NoDIEGU0HhE7+ZyY8D1IMY7odu5lRrFXGg71L15KG8QrPmum45RTtdA==",
      "dev": true,
    ...
    "node_modules/netlify-cli/node_modules/through2/node_modules/safe-buffer": {
      "version": "5.1.2",
      "resolved": "https://registry.npmjs.org/safe-buffer/-/safe-buffer-5.1.2.tgz",
      "integrity": "sha512-Gd2UZBJDkXlY7GbJxfsE8/nvKkUEU1G38c1siN6QP6a9PT9MmHB8GnpscSmMJSoF8LOIrt8ud/wPtojys4G6+g==",
      "dev": true
    },
    "node_modules/netlify-cli/node_modules/through2/node_modules/string_decoder": {
      "version": "1.1.1",
      "resolved": "https://registry.npmjs.org/string_decoder/-/string_decoder-1.1.1.tgz",
      "integrity": "sha512-n/ShnvDi6FHbbVfviro+WojiFzv+s8MPMHBczVePfUpDJLwoLT0ht1l4YwBCbi8pJAveEEdnkHyPyTP/mzRfwg==",
      "dev": true,
    ...
    "node_modules/netlify-cli/node_modules/trim-repeated": {
      "version": "2.0.0",
    ...
    "node_modules/netlify-cli/node_modules/ts-api-utils": {
      "version": "2.1.0",
    ...
    "node_modules/netlify-cli/node_modules/unstorage/node_modules/chokidar": {
      "version": "5.0.0",
    ...
    "node_modules/netlify-cli/node_modules/unstorage/node_modules/lru-cache": {
      "version": "11.2.5",
      "resolved": "https://registry.npmjs.org/lru-cache/-/lru-cache-11.2.5.tgz",
      "integrity": "sha512-vFrFJkWtJvJnD5hg+hJvVE8Lh/TcMzKnTgCWmtBipwI5yLX/iX+5UB2tfuyODF5E7k9xEzMdYgGqaSb1c0c5Yw==",
      "dev": true,
    ...
    "node_modules/netlify-cli/node_modules/unstorage/node_modules/readdirp": {
      "version": "5.0.0",
    ...
    "node_modules/netlify-cli/node_modules/untun/node_modules/pathe": {
      "version": "1.1.2",
      "resolved": "https://registry.npmjs.org/pathe/-/pathe-1.1.2.tgz",
      "integrity": "sha512-whLdWMYL2TwI08hn8/ZqAbrVemu0LNaNNJZX73O6qaIdCTfXutsLhMkjdENX0qhsQ9uIimo4/aQOmXkoon2nDQ==",
      "dev": true
    ...
    "node_modules/netlify-cli/node_modules/wcwidth": {
      "version": "1.0.1",
    ...
    "node_modules/netlify-cli/node_modules/webidl-conversions": {
      "version": "3.0.1",
    ...
    "node_modules/netlify-cli/node_modules/windows-release/node_modules/execa": {
      "version": "8.0.1",
      "resolved": "https://registry.npmjs.org/execa/-/execa-8.0.1.tgz",
      "integrity": "sha512-VyhnebXciFV2DESc+p6B+y0LjSm0krU4OgJN44qFAhBY0TJ+1V61tYD2+wHusZ6F9n5K+vl8k0sTy7PEfV4qpg==",
      "dev": true,
    ...
    "node_modules/netlify-cli/node_modules/windows-release/node_modules/get-stream": {
      "version": "8.0.1",
      "resolved": "https://registry.npmjs.org/get-stream/-/get-stream-8.0.1.tgz",
      "integrity": "sha512-VaUJspBffn/LMCJVoMvSAdmscJyS1auj5Zulnn5UoYcY531UWmdwhRWkcGKnGU93m5HSXP9LP2usOryrBtQowA==",
      "dev": true,
    ...
    "node_modules/netlify-cli/node_modules/windows-release/node_modules/human-signals": {
      "version": "5.0.0",
      "resolved": "https://registry.npmjs.org/human-signals/-/human-signals-5.0.0.tgz",
      "integrity": "sha512-AXcZb6vzzrFAUE61HnN4mpLqd/cSIwNQjtNWR0euPm6y0iqx3G4gOXaIDdtdDwZmhwe82LA6+zinmW4UBWVePQ==",
      "dev": true,
    ...
    "node_modules/netlify-cli/node_modules/windows-release/node_modules/is-stream": {
      "version": "3.0.0",
      "resolved": "https://registry.npmjs.org/is-stream/-/is-stream-3.0.0.tgz",
      "integrity": "sha512-LnQR4bZ9IADDRSkvpqMGvt/tEJWclzklNgSw48V5EAaAeDd6qGvN8ei6k5p0tvxSR171VmGyHuTiAOfxAbr8kA==",
      "dev": true,
    ...
    "node_modules/netlify-cli/node_modules/windows-release/node_modules/npm-run-path": {
      "version": "5.3.0",
      "resolved": "https://registry.npmjs.org/npm-run-path/-/npm-run-path-5.3.0.tgz",
      "integrity": "sha512-ppwTtiJZq0O/ai0z7yfudtBpWIoxM8yE6nHi1X47eFR2EWORqfbu6CnPlNsjeN683eT0qG6H/Pyf9fCcvjnnnQ==",
      "dev": true,
    ...
    "node_modules/netlify-cli/node_modules/windows-release/node_modules/onetime": {
      "version": "6.0.0",
      "resolved": "https://registry.npmjs.org/onetime/-/onetime-6.0.0.tgz",
      "integrity": "sha512-1FlR+gjXK7X+AsAHso35MnyN5KqGwJRi/31ft6x0M194ht7S+rWAvd7PHss9xSKMzE0asv1pyIHaJYq+BbacAQ==",
      "dev": true,
    ...
    "node_modules/netlify-cli/node_modules/windows-release/node_modules/signal-exit": {
      "version": "4.1.0",
      "resolved": "https://registry.npmjs.org/signal-exit/-/signal-exit-4.1.0.tgz",
      "integrity": "sha512-bzyZ1e88w9O1iNJbKnOlvYTrWPDl46O1bG0D3XInv+9tkPrxrN8jUUTiFlDkkmKWgn1M6CfIA13SuGqOa9Korw==",
      "dev": true,
    ...
    "node_modules/netlify-cli/node_modules/windows-release/node_modules/strip-final-newline": {
      "version": "3.0.0",
      "resolved": "https://registry.npmjs.org/strip-final-newline/-/strip-final-newline-3.0.0.tgz",
      "integrity": "sha512-dOESqjYr96iWYylGObzd39EuNTa5VJxyvVAEm5Jnh7KGo75V43Hk1odPQkNDyXNmUR6k+gEiDVXnjB8HJ3crXw==",
      "dev": true,
    ...
    "node_modules/netlify-cli/node_modules/winston-transport/node_modules/readable-stream": {
      "version": "3.6.2",
      "resolved": "https://registry.npmjs.org/readable-stream/-/readable-stream-3.6.2.tgz",
      "integrity": "sha512-9u/sniCrY3D5WdsERHzHE4G2YCXqoG5FTHUiCC4SIbr6XcLZBY05ya9EKjYek9O5xOAwjGq+1JdGBAS7Q9ScoA==",
      "dev": true,
    ...
    "node_modules/netlify-cli/node_modules/winston/node_modules/readable-stream": {
      "version": "3.6.2",
      "resolved": "https://registry.npmjs.org/readable-stream/-/readable-stream-3.6.2.tgz",
      "integrity": "sha512-9u/sniCrY3D5WdsERHzHE4G2YCXqoG5FTHUiCC4SIbr6XcLZBY05ya9EKjYek9O5xOAwjGq+1JdGBAS7Q9ScoA==",
      "dev": true,
    ...
    "node_modules/netlify-cli/node_modules/wrap-ansi-cjs/node_modules/ansi-regex": {
      "version": "5.0.1",
      "resolved": "https://registry.npmjs.org/ansi-regex/-/ansi-regex-5.0.1.tgz",
      "integrity": "sha512-quJQXlTSUGL2LH9SUXo8VwsY4soanhgo6LNSm84E1LBcE8s3O0wpdiRzyR9z/ZZJMlMWv37qOOb9pdJlMUEKFQ==",
      "dev": true,
    ...
    "node_modules/netlify-cli/node_modules/wrap-ansi-cjs/node_modules/emoji-regex": {
      "version": "8.0.0",
      "resolved": "https://registry.npmjs.org/emoji-regex/-/emoji-regex-8.0.0.tgz",
      "integrity": "sha512-MSjYzcWNOA0ewAHpz0MxpYFvwg6yjy1NG3xteoqz644VCo/RPgnr1/GGt+ic3iJTzQ8Eu3TdM14SawnVUmGE6A==",
      "dev": true
    },
    "node_modules/netlify-cli/node_modules/wrap-ansi-cjs/node_modules/is-fullwidth-code-point": {
      "version": "3.0.0",
      "resolved": "https://registry.npmjs.org/is-fullwidth-code-point/-/is-fullwidth-code-point-3.0.0.tgz",
      "integrity": "sha512-zymm5+u+sCsSWyD9qNaejV3DFvhCKclKdizYaJUuHA83RLjb7nSuGnddCHGv0hk+KY7BMAlsWeK4Ueg6EV6XQg==",
      "dev": true,
    ...
    "node_modules/netlify-cli/node_modules/wrap-ansi-cjs/node_modules/string-width": {
      "version": "4.2.3",
      "resolved": "https://registry.npmjs.org/string-width/-/string-width-4.2.3.tgz",
      "integrity": "sha512-wKyQRQpjJ0sIp62ErSZdGsjMJWsap5oRNihHhu6G7JVO/9jIB6UyevL+tXuOqrng8j/cxKTWyWUwvSTriiZz/g==",
      "dev": true,
    ...
    "node_modules/netlify-cli/node_modules/yaml": {
      "version": "2.8.1",
    ...
    "node_modules/netlify-cli/node_modules/yargs-parser": {
      "version": "21.1.1",
    ...
    "node_modules/netlify-cli/node_modules/yargs/node_modules/ansi-regex": {
      "version": "5.0.1",
      "resolved": "https://registry.npmjs.org/ansi-regex/-/ansi-regex-5.0.1.tgz",
      "integrity": "sha512-quJQXlTSUGL2LH9SUXo8VwsY4soanhgo6LNSm84E1LBcE8s3O0wpdiRzyR9z/ZZJMlMWv37qOOb9pdJlMUEKFQ==",
      "dev": true,
    ...
    "node_modules/netlify-cli/node_modules/yargs/node_modules/emoji-regex": {
      "version": "8.0.0",
      "resolved": "https://registry.npmjs.org/emoji-regex/-/emoji-regex-8.0.0.tgz",
      "integrity": "sha512-MSjYzcWNOA0ewAHpz0MxpYFvwg6yjy1NG3xteoqz644VCo/RPgnr1/GGt+ic3iJTzQ8Eu3TdM14SawnVUmGE6A==",
      "dev": true
    },
    "node_modules/netlify-cli/node_modules/yargs/node_modules/is-fullwidth-code-point": {
      "version": "3.0.0",
      "resolved": "https://registry.npmjs.org/is-fullwidth-code-point/-/is-fullwidth-code-point-3.0.0.tgz",
      "integrity": "sha512-zymm5+u+sCsSWyD9qNaejV3DFvhCKclKdizYaJUuHA83RLjb7nSuGnddCHGv0hk+KY7BMAlsWeK4Ueg6EV6XQg==",
      "dev": true,
    ...
    "node_modules/netlify-cli/node_modules/yargs/node_modules/string-width": {
      "version": "4.2.3",
      "resolved": "https://registry.npmjs.org/string-width/-/string-width-4.2.3.tgz",
      "integrity": "sha512-wKyQRQpjJ0sIp62ErSZdGsjMJWsap5oRNihHhu6G7JVO/9jIB6UyevL+tXuOqrng8j/cxKTWyWUwvSTriiZz/g==",
      "dev": true,
    ...
    "node_modules/netlify-cli/node_modules/yauzl/node_modules/buffer-crc32": {
      "version": "0.2.13",
    ...
    "node_modules/netlify-cli/node_modules/yocto-queue": {
      "version": "1.2.2",
...
```json
{
  ...
  "type": "module",
  "scripts": {
    "build": "node scripts/build-news.mjs",
    "dev": "netlify dev"
  },
  "dependencies": {
    "@netlify/identity": "^1.2.0",
